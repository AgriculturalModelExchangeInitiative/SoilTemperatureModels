...
# -*- coding: latin-1 -*-
# This file has been generated at Fri Mar  3 09:18:08 2023
...
SurfacePartonSoilSWATC = CompositeNodeFactory(name='SurfacePartonSoilSWATC',
 ...
 '    ShortDescription: None\n'),
   ...
   3: ('amei.crop2ml.biomasurfacepartonsoilswatc', 'SoilTemperatureSWAT')},
                             elt_connections={  4427174208: (2, 0, '__out__', 0),
   4427174240: (2, 1, '__out__', 1),
   4427174272: (2, 2, '__out__', 2),
   4427174304: (3, 0, '__out__', 3),
   4427174336: ('__in__', 0, 2, 1),
   4427174368: ('__in__', 1, 2, 2),
   4427174400: ('__in__', 2, 2, 4),
   4427174432: ('__in__', 3, 2, 0),
   4427174464: ('__in__', 4, 2, 6),
   4427174496: ('__in__', 5, 3, 0),
   4427174528: ('__in__', 6, 3, 1),
   4427174560: ('__in__', 7, 3, 3),
   4427174592: ('__in__', 8, 3, 4),
   4427174624: ('__in__', 9, 3, 5),
   4427174656: ('__in__', 10, 3, 7),
   4427174688: (2, 0, 3, 2)},
