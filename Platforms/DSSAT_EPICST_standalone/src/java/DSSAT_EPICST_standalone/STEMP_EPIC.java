...
public class STEMP_EPIC
{
    ...
    public SOILT_EPIC Calculate_SOILT_EPIC (Integer NL, Double B, Double BCV, Double CUMDPT, Double DP, Double [] DSMID, Integer NLAYR, Double PESW, Double TAV, Double TAVG, Double TMAX, Double TMIN, Integer WetDay, Double WFT, Double WW, Double [] TMA, Double X2_PREV, Double [] ST)
    {
        Integer K;
        Integer L;
        Double DD;
