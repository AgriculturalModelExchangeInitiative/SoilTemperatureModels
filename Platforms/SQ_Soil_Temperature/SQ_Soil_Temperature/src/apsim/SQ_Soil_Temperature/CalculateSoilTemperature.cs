public class Calculatesoiltemperature: Model
{
    ...
    public void  Calculate_calculatesoiltemperature(SoiltemperatureState s, SoiltemperatureState s1, SoiltemperatureRate r, SoiltemperatureAuxiliary a)
    {
