...
def simulation(datafile, vardata, params, init):
    ...
    #outputs
    output_names = ["CUMDPT","DSMID","TMA","ATOT","SRFTEMP","ST"]
    ...
    for i in range(0,len(df.index)-1):
        ...
        SRAD = t_SRAD[i]
        ATOT = t_ATOT[i]
        CUMDPT,DSMID,TMA,ATOT,SRFTEMP,ST= STEMP_Component.model_stemp_(DSMID,TAVG,ST,TMAX,TAV,DLAYR,CUMDPT,SW,TAMP,NLAYR,DOY,LL,TMA,ISWWAT,DUL,BD,SRFTEMP,DS,NL,XLAT,SRAD,MSALB,ATOT)

        df_out.loc[i] = [CUMDPT,DSMID,TMA,ATOT,SRFTEMP,ST]
