...
CONTAINS
    ...
    SUBROUTINE model_surfacepartonsoilswatc(GlobalSolarRadiation, &
    ...
    !                          ** min : -60
    !                          ** unit : Â°C
        call model_surfacetemperatureparton(AboveGroundBiomass,  &
                GlobalSolarRadiation, AirTemperatureMinimum,  &
                SurfaceTemperatureMaximum, DayLength, SurfaceTemperatureMinimum,  &
                AirTemperatureMaximum,SurfaceSoilTemperature)
        call model_soiltemperatureswat(LayerThickness,  &
                VolumetricWaterContent, SurfaceSoilTemperature, SoilProfileDepth,  &
                AirTemperatureAnnualAverage, LagCoefficient, SoilTemperatureByLayers,  &
                BulkDensity)
