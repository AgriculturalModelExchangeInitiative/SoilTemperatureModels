...
namespace Model.Model.SurfacePartonSoilSWATC
{
    class SurfacePartonSoilSWATCWrapper :  UniverseLink
    {
        ...
        public void EstimateSurfacePartonSoilSWATC(double GlobalSolarRadiation, double AirTemperatureMaximum, double AirTemperatureMinimum, double DayLength, double AirTemperatureAnnualAverage)
        {
