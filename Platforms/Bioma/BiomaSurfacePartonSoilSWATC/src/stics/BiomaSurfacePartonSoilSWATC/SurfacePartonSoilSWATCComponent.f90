...
CONTAINS
    ...
    !                          ** min : -60
    !                          ** unit : Â°C
        call model_surfacetemperatureparton(SurfaceTemperatureMaximum,  &
                GlobalSolarRadiation, SurfaceTemperatureMinimum, AboveGroundBiomass,  &
                AirTemperatureMinimum, AirTemperatureMaximum,  &
                DayLength,SurfaceSoilTemperature)
        call model_soiltemperatureswat(SoilTemperatureByLayers,  &
                SurfaceSoilTemperature, AirTemperatureAnnualAverage,  &
                SoilProfileDepth, LagCoefficient, BulkDensity,  &
