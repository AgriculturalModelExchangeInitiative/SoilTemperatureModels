...
model_surfacetemperatureswat <- function (AirTemperatureMinimum,
    ...
    SurfaceSoilTemperature <- _WeightingActual * SoilTemperatureByLayers[1] + ((1 - _WeightingActual) * _Tbare)
    return (list('SurfaceSoilTemperature' = SurfaceSoilTemperature))
}