...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        SurfaceSoilTemperature,SoilTemperatureByLayers= SurfaceSWATSoilSWATCComponent.model_surfaceswatsoilswatc(AirTemperatureMinimum,GlobalSolarRadiation,AboveGroundBiomass,WaterEquivalentOfSnowPack,AirTemperatureMaximum,Albedo,AirTemperatureAnnualAverage,VolumetricWaterContent,BulkDensity,SoilProfileDepth,LayerThickness,LagCoefficient)
