...
namespace UNIMI.SoilT.Strategies.Composite
{
    ...
    /// <summary>
    ///Class SurfacePartonSoilSWATHourlyPartonC
    /// Composite strategy for the calculation of surface temperature with Parton's method and soil temperature with SWAT method. See also references of the associated strategies.
    /// </summary>
    public class SurfacePartonSoilSWATHourlyPartonC : IStrategySoilT
    {

        #region Constructor

        public SurfacePartonSoilSWATHourlyPartonC()
        {
            ...
            lAssStrat0_0.Add(typeof(UNIMI.SoilT.Strategies.Composite.ThermalDiffusivityC).FullName);
            lAssStrat0_0.Add(typeof(UNIMI.SoilT.Strategies.Soil.RangeOfSoilTemperaturesDAYCENT).FullName);
            lAssStrat0_0.Add(typeof(UNIMI.SoilT.Strategies.Soil.HourlySoilTemperaturesPartonLogan).FullName);
        ...
        public void SetParametersDefaultValue()
        {
            ...
            _thermaldiffusivityc.SetParametersDefaultValue();
        ...
        public string TestPostConditions(UNIMI.SoilT.Interfaces.Rates rates, UNIMI.SoilT.Interfaces.States states, UNIMI.SoilT.Interfaces.Auxiliary auxiliary, UNIMI.SoilT.Interfaces.States states1, UNIMI.SoilT.Interfaces.Exogenous exogenous, UNIMI.SoilT.Interfaces.StatesExternal statesexternal, string callID)
        {
            try
            {
                ...
                ret += _thermaldiffusivityc.TestPostConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Composite.ThermalDiffusivityC");
                ret += _rangeofsoiltemperaturesdaycent.TestPostConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.RangeOfSoilTemperaturesDAYCENT");
                ret += _hourlysoiltemperaturespartonlogan.TestPostConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.HourlySoilTemperaturesPartonLogan");
        ...
        public string TestPreConditions(UNIMI.SoilT.Interfaces.Rates rates, UNIMI.SoilT.Interfaces.States states, UNIMI.SoilT.Interfaces.Auxiliary auxiliary, UNIMI.SoilT.Interfaces.States states1, UNIMI.SoilT.Interfaces.Exogenous exogenous, UNIMI.SoilT.Interfaces.StatesExternal statesexternal, string callID)
        {
            try
            {
                ...
                ret += _thermaldiffusivityc.TestPreConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Composite.ThermalDiffusivityC");
                ret += _rangeofsoiltemperaturesdaycent.TestPreConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.RangeOfSoilTemperaturesDAYCENT");
                ret += _hourlysoiltemperaturespartonlogan.TestPreConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.HourlySoilTemperaturesPartonLogan");
        ...
        //cyml UNIMI.SoilT.Strategies.Composite.ThermalDiffusivityC _thermaldiffusivityc = new UNIMI.SoilT.Strategies.Composite.ThermalDiffusivityC();
        UNIMI.SoilT.Strategies.Soil.VolumetricHeatCapacityKluitenberg _volumetricheatcapacitykluitenberg = new UNIMI.SoilT.Strategies.Soil.VolumetricHeatCapacityKluitenberg();
        UNIMI.SoilT.Strategies.Soil.ThermalConductivitySimulat _thermalconductivitysimulat = new UNIMI.SoilT.Strategies.Soil.ThermalConductivitySimulat();

        UNIMI.SoilT.Strategies.Soil.ThermalDiffu _thermaldiffu = new UNIMI.SoilT.Strategies.Soil.ThermalDiffu();

        UNIMI.SoilT.Strategies.Soil.RangeOfSoilTemperaturesDAYCENT _rangeofsoiltemperaturesdaycent = new UNIMI.SoilT.Strategies.Soil.RangeOfSoilTemperaturesDAYCENT();
        UNIMI.SoilT.Strategies.Soil.HourlySoilTemperaturesPartonLogan _hourlysoiltemperaturespartonlogan = new UNIMI.SoilT.Strategies.Soil.HourlySoilTemperaturesPartonLogan();
        ...
        private void EstimateOfAssociatedClasses(UNIMI.SoilT.Interfaces.Rates rates, UNIMI.SoilT.Interfaces.States states, UNIMI.SoilT.Interfaces.Auxiliary auxiliary, UNIMI.SoilT.Interfaces.States states1, UNIMI.SoilT.Interfaces.Exogenous exogenous, UNIMI.SoilT.Interfaces.StatesExternal statesexternal, CRA.AgroManagement.ActEvents actevents)
        {
            ...
            //Cyml _thermaldiffusivityc.Estimate(rates, states, auxiliary, states1, exogenous, statesexternal, actevents);
            _volumetricheatcapacitykluitenberg.Estimate(rates,states,auxiliary,states1,exogenous,statesexternal,actevents);
            _thermalconductivitysimulat.Estimate(rates,states,auxiliary,states1,exogenous,statesexternal,actevents);
            _thermaldiffu.Estimate(rates,states,auxiliary,states1,exogenous,statesexternal,actevents);
        
            /*Cymlfor (int i = 0; i < states.ThermalDiffusivity.Length; i++)
            {
                states.ThermalDiffusivity[i] = (states.ThermalConductivity[i] / states.HeatCapacity[i]) / 100;
            } */       
            _rangeofsoiltemperaturesdaycent.Estimate(rates, states, auxiliary, states1, exogenous, statesexternal, actevents);
            _hourlysoiltemperaturespartonlogan.Estimate(rates, states, auxiliary, states1, exogenous, statesexternal, actevents);
        }
