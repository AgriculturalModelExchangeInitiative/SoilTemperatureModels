library(gsubfn)
library (gsubfn) 
setwd('C:/Users/midingoy/Documents/dssat/SoilTemperature/DSSAT_EPICST_standalone/src/r')
source('Stemp_epic.r')

model_stemp_epic_ <- function (DS,
         TAVG,
         TAV,
         ISWWAT,
         CUMDPT,
    ...
    #'                          ** min : 
    #'                          ** unit : degC
    list[SRFTEMP, NDays, TDL, WetDay, ST, TMA, X2_PREV] <- model_stemp_epic(NL, ISWWAT, BD, DLAYR, DS, DUL, LL, NLAYR, TAMP, RAIN, CUMDPT, DSMID, SW, TAVG, TMAX, TMIN, TAV, SRFTEMP, NDays, TDL, WetDay, ST, TMA, X2_PREV, DEPIR, BIOMAS, MULCHMASS, SNOW)
    return (list ("SRFTEMP" = SRFTEMP,"NDays" = NDays,"TDL" = TDL,"WetDay" = WetDay,"ST" = ST,"TMA" = TMA,"X2_PREV" = X2_PREV))
}