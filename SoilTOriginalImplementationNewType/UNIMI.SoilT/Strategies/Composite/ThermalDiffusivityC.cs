...
namespace UNIMI.SoilT.Strategies.Composite
{
    ...
    /// <summary>
    ///Class ThermalDiffusivityC
    /// Composite strategy for the calculation of soil thermal diffusivity. J.M.H.Hendrickx, H. Xie, B. Borchers, J.B.J. Harrison, 2008. Global Prediction of Thermal Soil Regimes. SPIE Proceedings Volume 6953 Detection and Sensing of Mines, Explosive Objects, and Obscured Targets XIII.
    /// </summary>
    public class ThermalDiffusivityC : IStrategySoilT
    {

        #region Constructor

        public ThermalDiffusivityC()
        {
            ...
            pd1.PropertyType = ((UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity)).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo = (UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity);
            _outputs0_0.Add(pd1);
            mo0_0.Outputs = _outputs0_0;
            //Associated strategies
            List<string> lAssStrat0_0 = new List<string>();
            lAssStrat0_0.Add(typeof(UNIMI.SoilT.Strategies.Soil.VolumetricHeatCapacityKluitenberg).FullName);
            lAssStrat0_0.Add(typeof(UNIMI.SoilT.Strategies.Soil.ThermalConductivitySIMULAT).FullName);
        ...
        {
            get { return "Composite strategy for the calculation of soil thermal diffusivity. J.M.H.Hendrickx, H. Xie, B. Borchers, J.B.J. Harrison, 2008. Global Prediction of Thermal Soil Regimes. SPIE Proceedings Volume 6953 Detection and Sensing of Mines, Explosive Objects, and Obscured Targets XIII."; }
        }
        ...
        public string TestPostConditions(UNIMI.SoilT.Interfaces.Rates rates, UNIMI.SoilT.Interfaces.States states, UNIMI.SoilT.Interfaces.Auxiliary auxiliary, UNIMI.SoilT.Interfaces.States states1, UNIMI.SoilT.Interfaces.Exogenous exogenous, UNIMI.SoilT.Interfaces.StatesExternal statesexternal, string callID)
        {
            try
            {
                ...
                int numeberOfLayers = states.HeatCapacity.Length;

                for (int i = 0; i < numeberOfLayers; i++)
                {
                    UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity.CurrentValue = states.ThermalDiffusivity;
                    RangeBasedCondition r1 = new RangeBasedCondition(UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity);
                    if (r1.ApplicableVarInfoValueTypes.Contains(UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity.ValueType)) { prc.AddCondition(r1); }
                }


                string ret = "";
                ret += _volumetricheatcapacitykluitenberg.TestPostConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.VolumetricHeatCapacityKluitenberg");
                ret += _thermalconductivitysimulat.TestPostConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.ThermalConductivitySIMULAT");
        ...
        public string TestPreConditions(UNIMI.SoilT.Interfaces.Rates rates, UNIMI.SoilT.Interfaces.States states, UNIMI.SoilT.Interfaces.Auxiliary auxiliary, UNIMI.SoilT.Interfaces.States states1, UNIMI.SoilT.Interfaces.Exogenous exogenous, UNIMI.SoilT.Interfaces.StatesExternal statesexternal, string callID)
        {
            try
            {
                ...
                string ret = "";
                ret += _volumetricheatcapacitykluitenberg.TestPreConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.VolumetricHeatCapacityKluitenberg");
                ret += _thermalconductivitysimulat.TestPreConditions(rates, states, auxiliary, states1, exogenous, statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.ThermalConductivitySIMULAT");
        ...
        public void Estimate(UNIMI.SoilT.Interfaces.Rates rates, UNIMI.SoilT.Interfaces.States states, UNIMI.SoilT.Interfaces.Auxiliary auxiliary, UNIMI.SoilT.Interfaces.States states1, UNIMI.SoilT.Interfaces.Exogenous exogenous, UNIMI.SoilT.Interfaces.StatesExternal statesexternal, CRA.AgroManagement.ActEvents actevents)
        {
            ...
            //{
            //    _layer.ThermalDiffusivity = (_layer.ThermalConductivity / _layer.HeatCapacity) / 100;
            //}
