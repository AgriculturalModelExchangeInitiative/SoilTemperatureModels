...
namespace UNIMI.SoilT.Strategies.Composite
{
	...
	/// <summary>
	///Class SurfacePartonSoilCampbellC
    /// Composite strategy for the calculation of surface temperature with Parton's method and soil temperature with Campbell's method. Parton, W. J. 1984. Predicting soil temperatures in a shortgrass steppe. Soil Science 138:93-101. and Campbell, G.S., Soil physics with basic. Elsevier 1985.  Composite strategy. See also references of the associated strategies.
    /// </summary>
	public class SurfacePartonSoilCampbellC : IStrategySoilT
	{

	#region Constructor

			public SurfacePartonSoilCampbellC()
			{
				
				ModellingOptions mo0_0 = new ModellingOptions();
				//Parameters
				List<VarInfo> _parameters0_0 = new List<VarInfo>();
				VarInfo v1 = new CompositeStrategyVarInfo(_soiltemperaturecampbell,"ThermalK");
				 _parameters0_0.Add(v1);
				VarInfo v2 = new CompositeStrategyVarInfo(_soiltemperaturecampbell,"ETA");
				 _parameters0_0.Add(v2);
				VarInfo v3 = new CompositeStrategyVarInfo(_soiltemperaturecampbell,"Timestep");
				 _parameters0_0.Add(v3);
				VarInfo v4 = new CompositeStrategyVarInfo(_soiltemperaturecampbell,"BottomTemperature");
				 _parameters0_0.Add(v4);
				VarInfo v5 = new CompositeStrategyVarInfo(_soiltemperaturecampbell,"DepthConstantSoilTemperature");
				...
				lAssStrat0_0.Add(typeof(UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell).FullName);
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Composite strategy for the calculation of surface temperature with Parton's method and soil temperature with Campbell's method. Parton, W. J. 1984. Predicting soil temperatures in a shortgrass steppe. Soil Science 138:93-101. and Campbell, G.S., Soil physics with basic. Elsevier 1985.  Composite strategy. See also references of the associated strategies."; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						return _soiltemperaturecampbell.ThermalK ;
				}
				set {
						_soiltemperaturecampbell.ThermalK=value;
				}
			}
			public System.Double ETA
			{ 
				get {
						return _soiltemperaturecampbell.ETA ;
				}
				set {
						_soiltemperaturecampbell.ETA=value;
				}
			}
			public System.Double Timestep
			{ 
				get {
						return _soiltemperaturecampbell.Timestep ;
				}
				set {
						_soiltemperaturecampbell.Timestep=value;
				}
			}
			public System.Double BottomTemperature
			{ 
				get {
						return _soiltemperaturecampbell.BottomTemperature ;
				}
				set {
						_soiltemperaturecampbell.BottomTemperature=value;
				}
			}
			public System.Double DepthConstantSoilTemperature
			{ 
				get {
						return _soiltemperaturecampbell.DepthConstantSoilTemperature ;
				}
				set {
						_soiltemperaturecampbell.DepthConstantSoilTemperature=value;
				}
			}
	...
	#region Parameters initialization method
            ...
            public void SetParametersDefaultValue()
            {
				_modellingOptionsManager.SetParametersDefaultValue();
					...
					_soiltemperaturecampbell.SetParametersDefaultValue(); 
	...
	#region Static parameters VarInfo definition
			...
			//Parameters static VarInfo list of the composite class
				...
				{
					get { return UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell.ThermalKVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell.ETAVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell.TimestepVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell.BottomTemperatureVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell.DepthConstantSoilTemperatureVarInfo; }
				}			
			...
			public string TestPostConditions(UNIMI.SoilT.Interfaces.Rates rates,UNIMI.SoilT.Interfaces.States states,UNIMI.SoilT.Interfaces.Auxiliary auxiliary,UNIMI.SoilT.Interfaces.States states1,UNIMI.SoilT.Interfaces.Exogenous exogenous,UNIMI.SoilT.Interfaces.StatesExternal statesexternal, string callID)
			{
				try
				{
					...
					string ret = "";
					 ...
					 ret += _soiltemperaturecampbell.TestPostConditions(rates,states,auxiliary,states1,exogenous,statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell");
			...
			public string TestPreConditions(UNIMI.SoilT.Interfaces.Rates rates,UNIMI.SoilT.Interfaces.States states,UNIMI.SoilT.Interfaces.Auxiliary auxiliary,UNIMI.SoilT.Interfaces.States states1,UNIMI.SoilT.Interfaces.Exogenous exogenous,UNIMI.SoilT.Interfaces.StatesExternal statesexternal, string callID)
			{
				try
				{
					...
					string ret = "";
					 ...
					 ret += _soiltemperaturecampbell.TestPreConditions(rates,states,auxiliary,states1,exogenous,statesexternal, "strategy UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell");
	...
	#region Model
			...
			UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell _soiltemperaturecampbell = new UNIMI.SoilT.Strategies.Soil.SoilTemperatureCampbell();
			...
			private void EstimateOfAssociatedClasses(UNIMI.SoilT.Interfaces.Rates rates,UNIMI.SoilT.Interfaces.States states,UNIMI.SoilT.Interfaces.Auxiliary auxiliary,UNIMI.SoilT.Interfaces.States states1,UNIMI.SoilT.Interfaces.Exogenous exogenous,UNIMI.SoilT.Interfaces.StatesExternal statesexternal,CRA.AgroManagement.ActEvents actevents){
				...
				_soiltemperaturecampbell.Estimate(rates,states,auxiliary,states1,exogenous,statesexternal,actevents);
			}
