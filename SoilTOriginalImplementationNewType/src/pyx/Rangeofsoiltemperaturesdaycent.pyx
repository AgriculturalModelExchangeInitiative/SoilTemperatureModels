import numpy 
from math import *
def model_rangeofsoiltemperaturesdaycent(float SoilTemperatureByLayers[['array', 'double']],
                                         float SurfaceTemperatureMinimum,
                                         float ThermalDiffusivity[['array', 'double']],
    ...
    """
    cdef float SoilTemperatureMinimum[['array', 'double']]
    cdef float SoilTemperatureRangeByLayers[['array', 'double']]
    cdef float SoilTemperatureMaximum[['array', 'double']]
    cdef int i 
