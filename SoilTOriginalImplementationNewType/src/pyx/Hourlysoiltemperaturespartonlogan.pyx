import numpy 
from math import *
def model_hourlysoiltemperaturespartonlogan(float SoilTemperatureMinimum[['array', 'double']],
                                            float HourOfSunrise,
                                            float DayLength,
                                            float SoilTemperatureByLayersHourly[['array', 'double']],
                                            float SoilTemperatureMaximum[['array', 'double']],
                                            float HourOfSunset):
    """
