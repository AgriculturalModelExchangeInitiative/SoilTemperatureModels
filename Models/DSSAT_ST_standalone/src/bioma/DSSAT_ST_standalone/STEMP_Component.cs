...
namespace STEMP_.Strategies
{
    public class STEMP_Component : IStrategySTEMP_
    {
        public STEMP_Component()
        {
            ...
            VarInfo v1 = new CompositeStrategyVarInfo(_STEMP, "DLAYR");
            _parameters0_0.Add(v1);
            VarInfo v2 = new CompositeStrategyVarInfo(_STEMP, "SW");
            _parameters0_0.Add(v2);
            VarInfo v3 = new CompositeStrategyVarInfo(_STEMP, "NLAYR");
            _parameters0_0.Add(v3);
            VarInfo v4 = new CompositeStrategyVarInfo(_STEMP, "LL");
            _parameters0_0.Add(v4);
            VarInfo v5 = new CompositeStrategyVarInfo(_STEMP, "ISWWAT");
            _parameters0_0.Add(v5);
            VarInfo v6 = new CompositeStrategyVarInfo(_STEMP, "DUL");
            _parameters0_0.Add(v6);
            VarInfo v7 = new CompositeStrategyVarInfo(_STEMP, "BD");
            _parameters0_0.Add(v7);
            VarInfo v8 = new CompositeStrategyVarInfo(_STEMP, "DS");
            ...
            VarInfo v11 = new CompositeStrategyVarInfo(_STEMP, "MSALB");
            _parameters0_0.Add(v11);
            List<PropertyDescription> _inputs0_0 = new List<PropertyDescription>();
            PropertyDescription pd1 = new PropertyDescription();
            pd1.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd1.PropertyName = "DSMID";
            pd1.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.DSMID).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.DSMID);
            _inputs0_0.Add(pd1);
            PropertyDescription pd2 = new PropertyDescription();
            pd2.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd2.PropertyName = "TAVG";
            pd2.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG);
            _inputs0_0.Add(pd2);
            PropertyDescription pd3 = new PropertyDescription();
            pd3.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd3.PropertyName = "ST";
            pd3.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.ST);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd4.PropertyName = "TMAX";
            pd4.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd5.PropertyName = "TAV";
            pd5.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd6.PropertyName = "CUMDPT";
            pd6.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd7.PropertyName = "TAMP";
            pd7.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd8.PropertyName = "DOY";
            pd8.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY);
            _inputs0_0.Add(pd8);
            ...
            pd11.PropertyName = "SRAD";
            pd11.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd12.PropertyName = "ATOT";
            pd12.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.ATOT).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.ATOT);
            _inputs0_0.Add(pd12);
        ...
        public string TestPreConditions(STEMP_.DomainClass.STEMP_State s,STEMP_.DomainClass.STEMP_State s1,STEMP_.DomainClass.STEMP_Rate r,STEMP_.DomainClass.STEMP_Auxiliary a,STEMP_.DomainClass.STEMP_Exogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.DSMID);
                if(r1.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.DSMID.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG);
                if(r2.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.ST);
                if(r3.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.ST.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX);
                if(r4.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV);
                if(r5.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT);
                if(r6.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP);
                if(r7.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY);
                if(r8.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY.ValueType)){prc.AddCondition(r8);}
                ...
                RangeBasedCondition r11 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD);
                if(r11.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.ATOT);
                if(r12.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.ATOT.ValueType)){prc.AddCondition(r12);}
