...
namespace STEMP_.Strategies
{
    public class STEMP_Component : IStrategySTEMP_
    {
        public STEMP_Component()
        {
            ...
            VarInfo v1 = new CompositeStrategyVarInfo(_STEMP, "XLAT");
            _parameters0_0.Add(v1);
            VarInfo v2 = new CompositeStrategyVarInfo(_STEMP, "ISWWAT");
            _parameters0_0.Add(v2);
            VarInfo v3 = new CompositeStrategyVarInfo(_STEMP, "NLAYR");
            _parameters0_0.Add(v3);
            VarInfo v4 = new CompositeStrategyVarInfo(_STEMP, "DUL");
            _parameters0_0.Add(v4);
            VarInfo v5 = new CompositeStrategyVarInfo(_STEMP, "DS");
            _parameters0_0.Add(v5);
            VarInfo v6 = new CompositeStrategyVarInfo(_STEMP, "LL");
            _parameters0_0.Add(v6);
            VarInfo v7 = new CompositeStrategyVarInfo(_STEMP, "BD");
            _parameters0_0.Add(v7);
            VarInfo v8 = new CompositeStrategyVarInfo(_STEMP, "MSALB");
            _parameters0_0.Add(v8);
            VarInfo v9 = new CompositeStrategyVarInfo(_STEMP, "NL");
            _parameters0_0.Add(v9);
            VarInfo v10 = new CompositeStrategyVarInfo(_STEMP, "DLAYR");
            _parameters0_0.Add(v10);
            VarInfo v11 = new CompositeStrategyVarInfo(_STEMP, "SW");
            _parameters0_0.Add(v11);
            List<PropertyDescription> _inputs0_0 = new List<PropertyDescription>();
            PropertyDescription pd1 = new PropertyDescription();
            pd1.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd1.PropertyName = "SRFTEMP";
            pd1.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP);
            _inputs0_0.Add(pd1);
            PropertyDescription pd2 = new PropertyDescription();
            pd2.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd2.PropertyName = "TAMP";
            pd2.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP);
            _inputs0_0.Add(pd2);
            PropertyDescription pd3 = new PropertyDescription();
            pd3.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd3.PropertyName = "HDAY";
            pd3.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.HDAY).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.HDAY);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd4.PropertyName = "TMA";
            pd4.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.TMA).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.TMA);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd5.PropertyName = "CUMDPT";
            pd5.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd6.PropertyName = "ATOT";
            pd6.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.ATOT).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.ATOT);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(STEMP_.DomainClass.STEMP_State);
            pd7.PropertyName = "TDL";
            pd7.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.TDL).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.TDL);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd8.PropertyName = "SRAD";
            pd8.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD);
            _inputs0_0.Add(pd8);
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd9.PropertyName = "TAV";
            pd9.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV);
            _inputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd10.PropertyName = "TMAX";
            pd10.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX);
            _inputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(STEMP_.DomainClass.STEMP_Exogenous);
            pd11.PropertyName = "TAVG";
            pd11.PropertyType = (STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG);
            _inputs0_0.Add(pd11);
            ...
            pd14.PropertyType = (STEMP_.DomainClass.STEMP_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(STEMP_.DomainClass.STEMP_StateVarInfo.ST);
            _inputs0_0.Add(pd14);
        ...
        public string TestPreConditions(STEMP_.DomainClass.STEMP_State s,STEMP_.DomainClass.STEMP_State s1,STEMP_.DomainClass.STEMP_Rate r,STEMP_.DomainClass.STEMP_Auxiliary a,STEMP_.DomainClass.STEMP_Exogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP);
                if(r1.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP);
                if(r2.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.HDAY);
                if(r3.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.HDAY.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.TMA);
                if(r4.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.TMA.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT);
                if(r5.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.ATOT);
                if(r6.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.ATOT.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.TDL);
                if(r7.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.TDL.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD);
                if(r8.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV);
                if(r9.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX);
                if(r10.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG);
                if(r11.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG.ValueType)){prc.AddCondition(r11);}
                ...
                RangeBasedCondition r14 = new RangeBasedCondition(STEMP_.DomainClass.STEMP_StateVarInfo.ST);
                if(r14.ApplicableVarInfoValueTypes.Contains( STEMP_.DomainClass.STEMP_StateVarInfo.ST.ValueType)){prc.AddCondition(r14);}
