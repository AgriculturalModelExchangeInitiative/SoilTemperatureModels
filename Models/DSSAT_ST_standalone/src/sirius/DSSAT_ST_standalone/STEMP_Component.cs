...
{
    public class STEMP_Component : IStrategySiriusQualitySTEMP_
    {
        public STEMP_Component()
        {
            ...
            pd1.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX);
            _inputs0_0.Add(pd1);
            PropertyDescription pd2 = new PropertyDescription();
            pd2.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_State);
            pd2.PropertyName = "HDAY";
            pd2.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.HDAY).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.HDAY);
            _inputs0_0.Add(pd2);
            PropertyDescription pd3 = new PropertyDescription();
            pd3.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_State);
            pd3.PropertyName = "SRFTEMP";
            pd3.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_State);
            pd4.PropertyName = "ST";
            pd4.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ST);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous);
            pd5.PropertyName = "SRAD";
            pd5.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous);
            pd6.PropertyName = "TAMP";
            pd6.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_State);
            pd7.PropertyName = "TMA";
            pd7.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.TMA).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.TMA);
            _inputs0_0.Add(pd7);
            ...
            pd9.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT);
            _inputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous);
            pd10.PropertyName = "TAVG";
            pd10.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG);
            _inputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_State);
            pd11.PropertyName = "ATOT";
            pd11.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ATOT).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ATOT);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous);
            pd12.PropertyName = "TAV";
            pd12.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV);
            _inputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_State);
            pd13.PropertyName = "DSMID";
            pd13.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.DSMID).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.DSMID);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous);
            pd14.PropertyName = "DOY";
            pd14.PropertyType = (SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY);
            _inputs0_0.Add(pd14);
            ...
            lAssStrat0_0.Add(typeof(SiriusQualitySTEMP_.Strategies.STEMP).FullName);
        ...
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.MSALBVarInfo;} 
        }

        public static VarInfo NLVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.NLVarInfo;} 
        }

        public static VarInfo LLVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.LLVarInfo;} 
        }

        public static VarInfo NLAYRVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.NLAYRVarInfo;} 
        }

        public static VarInfo DSVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.DSVarInfo;} 
        }

        public static VarInfo DLAYRVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.DLAYRVarInfo;} 
        }

        public static VarInfo ISWWATVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.ISWWATVarInfo;} 
        }

        public static VarInfo BDVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.BDVarInfo;} 
        }

        public static VarInfo SWVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.SWVarInfo;} 
        }

        public static VarInfo XLATVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.XLATVarInfo;} 
        }

        public static VarInfo DULVarInfo
        {
            get { return SiriusQualitySTEMP_.Strategies.STEMP.DULVarInfo;} 
        }
        ...
        public string TestPostConditions(SiriusQualitySTEMP_.DomainClass.STEMP_State s,SiriusQualitySTEMP_.DomainClass.STEMP_State s1,SiriusQualitySTEMP_.DomainClass.STEMP_Rate r,SiriusQualitySTEMP_.DomainClass.STEMP_Auxiliary a,SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous ex,string callID)
        {
            try
            {
                ...
                string ret = "";
                ret += _STEMP.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualitySTEMP_.Strategies.STEMP_");
            ...
            {
                string msg = "Component SiriusQuality.STEMP_, " + this.GetType().Name + ": Unhandled exception running post-condition test. ";
        ...
        public string TestPreConditions(SiriusQualitySTEMP_.DomainClass.STEMP_State s,SiriusQualitySTEMP_.DomainClass.STEMP_State s1,SiriusQualitySTEMP_.DomainClass.STEMP_Rate r,SiriusQualitySTEMP_.DomainClass.STEMP_Auxiliary a,SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX);
                if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TMAX.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.HDAY);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.HDAY.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.SRFTEMP.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ST);
                if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ST.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD);
                if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.SRAD.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP);
                if(r6.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAMP.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.TMA);
                if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.TMA.ValueType)){prc.AddCondition(r7);}
                ...
                RangeBasedCondition r9 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT);
                if(r9.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.CUMDPT.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG);
                if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAVG.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ATOT);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.ATOT.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV);
                if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.TAV.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.DSMID);
                if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_StateVarInfo.DSMID.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_.DomainClass.STEMP_ExogenousVarInfo.DOY.ValueType)){prc.AddCondition(r14);}
                ...
                string ret = "";
                ret += _STEMP.TestPreConditions(s, s1, r, a, ex, " strategy SiriusQualitySTEMP_.Strategies.STEMP_");
            ...
            {
                string msg = "Component SiriusQuality.STEMP_, " + this.GetType().Name + ": Unhandled exception running pre-condition test. ";
                throw new Exception(msg, exception);
            }
        }
        ...
        private void EstimateOfAssociatedClasses(SiriusQualitySTEMP_.DomainClass.STEMP_State s,SiriusQualitySTEMP_.DomainClass.STEMP_State s1,SiriusQualitySTEMP_.DomainClass.STEMP_Rate r,SiriusQualitySTEMP_.DomainClass.STEMP_Auxiliary a,SiriusQualitySTEMP_.DomainClass.STEMP_Exogenous ex)
        {
