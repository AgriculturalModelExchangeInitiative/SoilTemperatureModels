...
CONTAINS
    ...
    SUBROUTINE model_surfaceswatsoilswatc(AirTemperatureMinimum, &
    ...
    !                          ** min : -60
    !                          ** unit : Â°C
        call model_surfacetemperatureswat(AirTemperatureMinimum,  &
                GlobalSolarRadiation, SoilTemperatureByLayers, AboveGroundBiomass,  &
                WaterEquivalentOfSnowPack, AirTemperatureMaximum,  &
                Albedo,SurfaceSoilTemperature)
        call model_soiltemperatureswat(SoilTemperatureByLayers,  &
                AirTemperatureAnnualAverage, VolumetricWaterContent, BulkDensity,  &
                SoilProfileDepth, LayerThickness, LagCoefficient,  &
                SurfaceSoilTemperature)
