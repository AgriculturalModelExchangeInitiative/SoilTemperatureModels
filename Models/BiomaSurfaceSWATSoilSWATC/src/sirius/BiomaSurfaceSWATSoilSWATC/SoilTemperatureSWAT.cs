...
namespace SiriusQualitySurfaceSWATSoilSWATC.Strategies
{
    public class SoilTemperatureSWAT : IStrategySiriusQualitySurfaceSWATSoilSWATC
    {
        public SoilTemperatureSWAT()
        {
            ...
            pd1.PropertyType = (SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCAuxiliaryVarInfo.VolumetricWaterContent).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCAuxiliaryVarInfo.VolumetricWaterContent);
            _inputs0_0.Add(pd1);
        ...
        public string TestPreConditions(SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCState s,SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCState s1,SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCRate r,SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCAuxiliary a,SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCExogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCAuxiliaryVarInfo.VolumetricWaterContent);
                if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualitySurfaceSWATSoilSWATC.DomainClass.SurfaceSWATSoilSWATCAuxiliaryVarInfo.VolumetricWaterContent.ValueType)){prc.AddCondition(r1);}
