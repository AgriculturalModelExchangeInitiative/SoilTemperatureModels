...
public class Campbell
{
    ...
    public static void  doThermalConductivityCoeffs(int nbLayers, int numNodes, double[] BDApsim, double[] CLAYApsim, out double[] thermalCondPar1, out double[] thermalCondPar2, out double[] thermalCondPar3, out double[] thermalCondPar4)
    {
        int layer;
        int element;
