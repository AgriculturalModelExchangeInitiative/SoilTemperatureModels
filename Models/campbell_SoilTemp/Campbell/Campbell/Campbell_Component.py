...
def model_SoilTemperatureCampbell(NLAYR: int,
    ...
    (soilTemp, minSoilTemp, maxSoilTemp, aveSoilTemp,
        ...
        rocks, carbon, sand, silt, airPressure) = model_campbell(numberLayer, thickness, depth, bulkDensity, 
                                                T2M[i], TMAX[i], TMIN[i], TAV, TAMP, XLAT, 
                                                clay, soilW, doy[0], airPressure, 
                                                canopyHeight, albedo, SRAD[i], ESP[i], ESP[i], 
