...
namespace SoilTemperature.Strategies
{
    public class SoilTemperatureComponent : IStrategySoilTemperature
    {
        public SoilTemperatureComponent()
        {
            ...
            VarInfo v2 = new CompositeStrategyVarInfo(_CalculateHourlySoilTemperature, "a");
            _parameters0_0.Add(v2);
            VarInfo v3 = new CompositeStrategyVarInfo(_CalculateHourlySoilTemperature, "b");
            _parameters0_0.Add(v3);
            VarInfo v4 = new CompositeStrategyVarInfo(_CalculateHourlySoilTemperature, "c");
        ...
        public string TestPostConditions(SoilTemperature.DomainClass.SoilTemperatureState s,SoilTemperature.DomainClass.SoilTemperatureState s1,SoilTemperature.DomainClass.SoilTemperatureRate r,SoilTemperature.DomainClass.SoilTemperatureAuxiliary a,SoilTemperature.DomainClass.SoilTemperatureExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r11 = new RangeBasedCondition(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.deepLayerT_t1);
                if(r11.ApplicableVarInfoValueTypes.Contains( SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.deepLayerT_t1.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.maxTSoil);
                if(r12.ApplicableVarInfoValueTypes.Contains( SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.maxTSoil.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.minTSoil);
                if(r13.ApplicableVarInfoValueTypes.Contains( SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.minTSoil.ValueType)){prc.AddCondition(r13);}
