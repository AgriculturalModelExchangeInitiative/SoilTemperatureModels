public class Calculatehourlysoiltemperature: Model
{
    private double _c;
    public double c
        {
    ...
    public void  Calculate_calculatehourlysoiltemperature(SoiltemperatureState s, SoiltemperatureState s1, SoiltemperatureRate r, SoiltemperatureAuxiliary a)
    {
