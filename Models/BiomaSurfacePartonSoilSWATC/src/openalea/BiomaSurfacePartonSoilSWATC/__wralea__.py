...
# This file has been generated at Sat Apr 29 08:26:34 2023

from openalea.core import *


__name__ = 'amei.crop2ml.biomasurfacepartonsoilswatc.surfacepartonsoilswatc'
...
SurfacePartonSoilSWATC = CompositeNodeFactory(name='SurfacePartonSoilSWATC',
 ...
 '    ShortDescription: None\n'),
   ...
   {'interface': ISequence, 'name': 'SoilTemperatureByLayers'}],
                             elt_factory={  2: (  'amei.crop2ml.biomasurfacepartonsoilswatc.surfacepartonsoilswatc',
         'SurfaceTemperatureParton'),
   3: (  'amei.crop2ml.biomasurfacepartonsoilswatc.surfacepartonsoilswatc',
         'SoilTemperatureSWAT')},
                             elt_connections={  140722495201648: (2, 0, '__out__', 0),
   140722495201680: (2, 1, '__out__', 1),
   140722495201712: (2, 2, '__out__', 2),
   140722495201744: (3, 0, '__out__', 3),
   140722495201776: ('__in__', 0, 2, 0),
   140722495201808: ('__in__', 1, 2, 1),
   140722495201840: ('__in__', 2, 2, 2),
   140722495201872: ('__in__', 3, 2, 3),
   140722495201904: ('__in__', 4, 2, 4),
   140722495201936: ('__in__', 5, 3, 0),
   140722495201968: ('__in__', 6, 3, 2),
   140722495202000: ('__in__', 7, 3, 3),
   140722495202032: ('__in__', 8, 3, 5),
   140722495202064: ('__in__', 9, 3, 6),
   140722495202096: ('__in__', 10, 3, 7),
   140722495202128: (2, 2, 3, 1)},
