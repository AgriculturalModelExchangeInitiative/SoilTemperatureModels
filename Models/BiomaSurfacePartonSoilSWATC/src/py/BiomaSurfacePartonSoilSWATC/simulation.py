...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        SurfaceTemperatureMinimum,SurfaceTemperatureMaximum,SurfaceSoilTemperature,SoilTemperatureByLayers= SurfacePartonSoilSWATCComponent.model_surfacepartonsoilswatc(AboveGroundBiomass,DayLength,AirTemperatureMinimum,GlobalSolarRadiation,AirTemperatureMaximum,BulkDensity,AirTemperatureAnnualAverage,LagCoefficient,LayerThickness,VolumetricWaterContent,SoilProfileDepth)
