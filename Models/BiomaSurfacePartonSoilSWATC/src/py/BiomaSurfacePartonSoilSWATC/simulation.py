...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        SurfaceTemperatureMinimum,SurfaceTemperatureMaximum,SurfaceSoilTemperature,SoilTemperatureByLayers= SurfacePartonSoilSWATCComponent.model_surfacepartonsoilswatc(DayLength,GlobalSolarRadiation,AboveGroundBiomass,AirTemperatureMinimum,AirTemperatureMaximum,LayerThickness,BulkDensity,SoilProfileDepth,AirTemperatureAnnualAverage,VolumetricWaterContent,LagCoefficient)
