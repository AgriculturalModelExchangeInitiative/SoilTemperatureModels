...
namespace SiriusQualitySTEMP_EPIC_.Strategies
{
    public class STEMP_EPIC : IStrategySiriusQualitySTEMP_EPIC_
    {
        public STEMP_EPIC()
        {
            ...
            pd10.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA);
            _inputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd11.PropertyName = "NDays";
            pd11.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd12.PropertyName = "WetDay";
            pd12.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
            _inputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd13.PropertyName = "X2_PREV";
            pd13.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd14.PropertyName = "SRFTEMP";
            pd14.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
            _inputs0_0.Add(pd14);
            ...
            pd15.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR);
            _inputs0_0.Add(pd16);
            ...
            pd17.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS);
            _inputs0_0.Add(pd17);
            ...
            pd18.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS);
            _inputs0_0.Add(pd18);
            PropertyDescription pd19 = new PropertyDescription();
            pd19.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd19.PropertyName = "SNOW";
            pd19.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW);
            _inputs0_0.Add(pd19);
        ...
        public string TestPreConditions(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s1,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Rate r,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Auxiliary a,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA);
                if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
                if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
                if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
                if(r15.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR);
                if(r16.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS);
                if(r17.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS.ValueType)){prc.AddCondition(r17);}
                RangeBasedCondition r18 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS);
                if(r18.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS.ValueType)){prc.AddCondition(r18);}
                RangeBasedCondition r19 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW);
                if(r19.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW.ValueType)){prc.AddCondition(r19);}
