...
{
    public class STEMP_EPIC : IStrategySiriusQualitySTEMP_EPIC_
    {
        public STEMP_EPIC()
        {
            ...
            pd1.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAMP).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAMP);
            _inputs0_0.Add(pd1);
            PropertyDescription pd2 = new PropertyDescription();
            pd2.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd2.PropertyName = "RAIN";
            pd2.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN);
            _inputs0_0.Add(pd2);
            PropertyDescription pd3 = new PropertyDescription();
            pd3.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd3.PropertyName = "TAVG";
            pd3.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd4.PropertyName = "TMAX";
            pd4.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd5.PropertyName = "TMIN";
            pd5.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMIN).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMIN);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd6.PropertyName = "TAV";
            pd6.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd7.PropertyName = "CUMDPT";
            pd7.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd8.PropertyName = "DSMID";
            pd8.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID);
            _inputs0_0.Add(pd8);
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd9.PropertyName = "TMA";
            pd9.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA);
            _inputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd10.PropertyName = "NDays";
            pd10.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
            _inputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd11.PropertyName = "WetDay";
            pd11.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd12.PropertyName = "X2_PREV";
            pd12.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
            _inputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd13.PropertyName = "SRFTEMP";
            pd13.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd14.PropertyName = "ST";
            pd14.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
            _inputs0_0.Add(pd14);
            PropertyDescription pd15 = new PropertyDescription();
            pd15.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd15.PropertyName = "DEPIR";
            pd15.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS);
            _inputs0_0.Add(pd16);
            PropertyDescription pd17 = new PropertyDescription();
            pd17.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd17.PropertyName = "MULCHMASS";
            pd17.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS);
            _inputs0_0.Add(pd17);
            PropertyDescription pd18 = new PropertyDescription();
            pd18.DomainClassType = typeof(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd18.PropertyName = "SNOW";
            pd18.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW);
            _inputs0_0.Add(pd18);
            ...
            pd20.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID).ValueType.TypeForCurrentValue;
            pd20.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID);
            ...
            pd21.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA).ValueType.TypeForCurrentValue;
            pd21.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA);
            ...
            pd22.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays).ValueType.TypeForCurrentValue;
            pd22.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
            ...
            pd23.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay).ValueType.TypeForCurrentValue;
            pd23.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
            ...
            pd24.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV).ValueType.TypeForCurrentValue;
            pd24.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
            ...
            pd25.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP).ValueType.TypeForCurrentValue;
            pd25.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
            ...
            pd26.PropertyType = (SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd26.PropertyVarInfo =(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
        ...
        public string TestPostConditions(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s1,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Rate r,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Auxiliary a,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r28 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT);
                if(r28.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID);
                if(r29.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA);
                if(r30.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA.ValueType)){prc.AddCondition(r30);}
                RangeBasedCondition r31 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
                if(r31.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays.ValueType)){prc.AddCondition(r31);}
                RangeBasedCondition r32 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
                if(r32.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay.ValueType)){prc.AddCondition(r32);}
                RangeBasedCondition r33 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
                if(r33.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV.ValueType)){prc.AddCondition(r33);}
                RangeBasedCondition r34 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
                if(r34.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP.ValueType)){prc.AddCondition(r34);}
                RangeBasedCondition r35 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
                if(r35.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST.ValueType)){prc.AddCondition(r35);}
                string postConditionsResult = pre.VerifyPostconditions(prc, callID); if (!string.IsNullOrEmpty(postConditionsResult)) { pre.TestsOut(postConditionsResult, true, "PostConditions errors in strategy " + this.GetType().Name); } return postConditionsResult;
            }
            catch (Exception exception)
            {
                string msg = "SiriusQuality.STEMP_EPIC_, " + this.GetType().Name + ": Unhandled exception running post-condition test. ";
        ...
        public string TestPreConditions(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s1,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Rate r,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Auxiliary a,SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAMP);
                if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAMP.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX);
                if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMIN);
                if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMIN.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV);
                if(r6.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT);
                if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID);
                if(r8.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.DSMID.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA);
                if(r9.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.TMA.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
                if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
                if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
                if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR);
                if(r15.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS);
                if(r16.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS);
                if(r17.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.MULCHMASS.ValueType)){prc.AddCondition(r17);}
                RangeBasedCondition r18 = new RangeBasedCondition(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW);
                if(r18.ApplicableVarInfoValueTypes.Contains( SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW.ValueType)){prc.AddCondition(r18);}
            ...
            {
                string msg = "SiriusQuality.STEMP_EPIC_, " + this.GetType().Name + ": Unhandled exception running pre-condition test. ";
                throw new Exception(msg, exception);
            }
        }
        ...
        public void Init(SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s, SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_State s1, SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Rate r, SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Auxiliary a, SiriusQualitySTEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous ex)
        {
            double TAMP;
            double RAIN;
            double TAVG;
