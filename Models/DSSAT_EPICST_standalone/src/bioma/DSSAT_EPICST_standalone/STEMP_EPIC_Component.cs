...
namespace STEMP_EPIC_.Strategies
{
    public class STEMP_EPIC_Component : IStrategySTEMP_EPIC_
    {
        public STEMP_EPIC_Component()
        {
            ...
            VarInfo v1 = new CompositeStrategyVarInfo(_STEMP_EPIC, "ISWWAT");
            _parameters0_0.Add(v1);
            VarInfo v2 = new CompositeStrategyVarInfo(_STEMP_EPIC, "NLAYR");
            _parameters0_0.Add(v2);
            VarInfo v3 = new CompositeStrategyVarInfo(_STEMP_EPIC, "DLAYR");
            ...
            VarInfo v7 = new CompositeStrategyVarInfo(_STEMP_EPIC, "SW");
            _parameters0_0.Add(v7);
            VarInfo v8 = new CompositeStrategyVarInfo(_STEMP_EPIC, "DUL");
            _parameters0_0.Add(v8);
            VarInfo v9 = new CompositeStrategyVarInfo(_STEMP_EPIC, "NL");
            _parameters0_0.Add(v9);
            List<PropertyDescription> _inputs0_0 = new List<PropertyDescription>();
            PropertyDescription pd1 = new PropertyDescription();
            pd1.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd1.PropertyName = "SNOW";
            pd1.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW);
            _inputs0_0.Add(pd1);
            PropertyDescription pd2 = new PropertyDescription();
            pd2.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd2.PropertyName = "CUMDPT";
            pd2.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT);
            _inputs0_0.Add(pd2);
            PropertyDescription pd3 = new PropertyDescription();
            pd3.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd3.PropertyName = "TMAX";
            pd3.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd4.PropertyName = "BIOMAS";
            pd4.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd5.PropertyName = "TAV";
            pd5.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV);
            _inputs0_0.Add(pd5);
            ...
            pd8.PropertyName = "ST";
            pd8.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
            _inputs0_0.Add(pd8);
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd9.PropertyName = "SRFTEMP";
            pd9.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
            _inputs0_0.Add(pd9);
            ...
            pd11.PropertyName = "X2_PREV";
            pd11.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
            _inputs0_0.Add(pd11);
            ...
            pd13.PropertyName = "RAIN";
            pd13.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous);
            pd14.PropertyName = "TAVG";
            pd14.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG);
            _inputs0_0.Add(pd14);
            ...
            pd15.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR);
            _inputs0_0.Add(pd15);
            PropertyDescription pd16 = new PropertyDescription();
            pd16.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd16.PropertyName = "WetDay";
            pd16.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
            _inputs0_0.Add(pd16);
            PropertyDescription pd17 = new PropertyDescription();
            pd17.DomainClassType = typeof(STEMP_EPIC_.DomainClass.STEMP_EPIC_State);
            pd17.PropertyName = "NDays";
            pd17.PropertyType = (STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
            _inputs0_0.Add(pd17);
        ...
        public string TestPreConditions(STEMP_EPIC_.DomainClass.STEMP_EPIC_State s,STEMP_EPIC_.DomainClass.STEMP_EPIC_State s1,STEMP_EPIC_.DomainClass.STEMP_EPIC_Rate r,STEMP_EPIC_.DomainClass.STEMP_EPIC_Auxiliary a,STEMP_EPIC_.DomainClass.STEMP_EPIC_Exogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW);
                if(r1.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.SNOW.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT);
                if(r2.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.CUMDPT.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX);
                if(r3.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TMAX.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS);
                if(r4.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.BIOMAS.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV);
                if(r5.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAV.ValueType)){prc.AddCondition(r5);}
                ...
                RangeBasedCondition r8 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST);
                if(r8.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.ST.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP);
                if(r9.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.SRFTEMP.ValueType)){prc.AddCondition(r9);}
                ...
                RangeBasedCondition r11 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV);
                if(r11.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.X2_PREV.ValueType)){prc.AddCondition(r11);}
                ...
                RangeBasedCondition r13 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN);
                if(r13.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.RAIN.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG);
                if(r14.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.TAVG.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR);
                if(r15.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_ExogenousVarInfo.DEPIR.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay);
                if(r16.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.WetDay.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays);
                if(r17.ApplicableVarInfoValueTypes.Contains( STEMP_EPIC_.DomainClass.STEMP_EPIC_StateVarInfo.NDays.ValueType)){prc.AddCondition(r17);}
