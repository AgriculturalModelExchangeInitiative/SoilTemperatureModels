...
class STEMP_EPIC
{
    ...
    public:
        ...
        tuple<vector<double> ,double,vector<double> ,double,double> SOILT_EPIC(int NL,double B,double BCV,double CUMDPT,double DP,vector<double>  DSMID,int NLAYR,double PESW,double TAV,double TAVG,double TMAX,double TMIN,int WetDay,double WFT,double WW,double X2_PREV);
        int getNL();
        void setNL(int _NL);
        string getISWWAT();
