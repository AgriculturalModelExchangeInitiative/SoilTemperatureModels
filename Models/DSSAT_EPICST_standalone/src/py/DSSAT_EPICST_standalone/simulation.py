...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        WetDay = t_WetDay[i]
        RAIN = t_RAIN[i]
        CUMDPT,DSMID,TMA,NDays,WetDay,X2_PREV,SRFTEMP,ST= STEMP_EPIC_Component.model_stemp_epic_(DLAYR,ISWWAT,TMA,SNOW,TAMP,CUMDPT,DEPIR,TMIN,ST,NL,SW,DSMID,MULCHMASS,TAVG,BD,NLAYR,TAV,SRFTEMP,NDays,DS,TMAX,DUL,BIOMAS,X2_PREV,WetDay,LL,RAIN)
