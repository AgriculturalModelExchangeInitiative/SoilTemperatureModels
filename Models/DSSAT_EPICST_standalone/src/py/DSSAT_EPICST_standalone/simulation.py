...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        CUMDPT,DSMID,TMA,NDays,WetDay,X2_PREV,SRFTEMP,ST= STEMP_EPIC_Component.model_stemp_epic_(SNOW,ISWWAT,CUMDPT,TMAX,NLAYR,BIOMAS,TAV,TMIN,DLAYR,TAMP,DS,LL,BD,ST,SW,DUL,SRFTEMP,TMA,X2_PREV,DSMID,RAIN,TAVG,DEPIR,WetDay,NL,NDays,MULCHMASS)
