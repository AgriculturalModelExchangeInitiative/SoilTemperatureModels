...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        TDL = t_TDL[i]
        WetDay = t_WetDay[i]
        CUMDPT,DSMID,TDL,TMA,NDays,WetDay,X2_PREV,SRFTEMP,ST= STEMP_EPIC_Component.model_stemp_epic_(DUL,TAVG,ST,TAV,TMAX,TMA,SRFTEMP,ISWWAT,BIOMAS,SNOW,TMIN,LL,DS,SW,NDays,DEPIR,DSMID,CUMDPT,X2_PREV,TAMP,MULCHMASS,BD,RAIN,NLAYR,TDL,WetDay,NL,DLAYR)
