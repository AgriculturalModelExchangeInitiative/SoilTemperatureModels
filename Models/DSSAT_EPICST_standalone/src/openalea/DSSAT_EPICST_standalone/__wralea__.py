...
# This file has been generated at Fri Mar  3 11:13:46 2023
...
__all__ = ['stemp_epic_model_stemp_epic', '_2232205248520']
...
_2232205248520 = CompositeNodeFactory(name='STEMP_EPIC_',
                             description=('\n'
 '\n'
 '    STEMP_EPIC_ model\n'
 ...
 '    ShortDescription: Determines soil temperature by layer test encore\n'),
   ...
   140732969689712: ('__in__', 0, 2, 3),
   140732969689744: ('__in__', 1, 2, 1),
   140732969689776: ('__in__', 2, 2, 17),
   140732969689808: ('__in__', 3, 2, 26),
   140732969689840: ('__in__', 4, 2, 8),
   140732969689872: ('__in__', 5, 2, 15),
   140732969689904: ('__in__', 6, 2, 23),
   140732969689936: ('__in__', 7, 2, 13),
   140732969689968: ('__in__', 8, 2, 22),
   140732969690000: ('__in__', 9, 2, 0),
   140732969690032: ('__in__', 10, 2, 10),
   140732969690064: ('__in__', 11, 2, 16),
   140732969690096: ('__in__', 12, 2, 25),
   140732969690128: ('__in__', 13, 2, 11),
   140732969690160: ('__in__', 14, 2, 2),
   140732969690192: ('__in__', 15, 2, 7),
   140732969690224: ('__in__', 16, 2, 14),
   140732969690256: ('__in__', 17, 2, 21),
   140732969690288: ('__in__', 18, 2, 18),
   140732969690320: ('__in__', 19, 2, 4),
   140732969690352: ('__in__', 20, 2, 12),
   140732969690384: ('__in__', 21, 2, 5),
   140732969690416: ('__in__', 22, 2, 24),
   140732969690448: ('__in__', 23, 2, 20),
   140732969690480: ('__in__', 24, 2, 19),
   140732969690512: ('__in__', 25, 2, 6),
   140732969690544: ('__in__', 26, 2, 9)},
