...
namespace soil_temp.Strategies
{
    public class update : IStrategysoil_temp
    {
        public update()
        {
            ...
            pd4.PropertyType = (soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp);
            _outputs0_0.Add(pd4);
        ...
        public string TestPostConditions(soil_temp.DomainClass.soil_tempState s,soil_temp.DomainClass.soil_tempState s1,soil_temp.DomainClass.soil_tempRate r,soil_temp.DomainClass.soil_tempAuxiliary a,soil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r4 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp);
                if(r4.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp.ValueType)){prc.AddCondition(r4);}
