...
namespace soil_temp.Strategies
{
    public class soil_tempComponent : IStrategysoil_temp
    {
        public soil_tempComponent()
        {
            ...
            pd9.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile);
            _outputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(soil_temp.DomainClass.soil_tempState);
            pd10.PropertyName = "layer_temp";
            pd10.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp);
            ...
            pd12.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.prev_canopy_temp).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.prev_canopy_temp);
        ...
        public string TestPostConditions(soil_temp.DomainClass.soil_tempState s,soil_temp.DomainClass.soil_tempState s1,soil_temp.DomainClass.soil_tempRate r,soil_temp.DomainClass.soil_tempAuxiliary a,soil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r11 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile);
                if(r11.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp);
                if(r12.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp.ValueType)){prc.AddCondition(r12);}
                ...
                RangeBasedCondition r14 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.prev_canopy_temp);
                if(r14.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.prev_canopy_temp.ValueType)){prc.AddCondition(r14);}
