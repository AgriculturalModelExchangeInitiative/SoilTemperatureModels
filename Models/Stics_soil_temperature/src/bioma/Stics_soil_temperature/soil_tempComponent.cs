...
namespace soil_temp.Strategies
{
    public class soil_tempComponent : IStrategysoil_temp
    {
        public soil_tempComponent()
        {
            ...
            pd3.DomainClassType = typeof(soil_temp.DomainClass.soil_tempAuxiliary);
            pd3.PropertyName = "temp_wave_freq";
            pd3.PropertyType = (soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(soil_temp.DomainClass.soil_tempAuxiliary);
            pd4.PropertyName = "therm_diff";
            pd4.PropertyType = (soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff);
            _inputs0_0.Add(pd4);
            ...
            pd6.DomainClassType = typeof(soil_temp.DomainClass.soil_tempExogenous);
            pd6.PropertyName = "min_canopy_temp";
            pd6.PropertyType = (soil_temp.DomainClass.soil_tempExogenousVarInfo.min_canopy_temp).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(soil_temp.DomainClass.soil_tempExogenousVarInfo.min_canopy_temp);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(soil_temp.DomainClass.soil_tempExogenous);
            pd7.PropertyName = "max_canopy_temp";
            pd7.PropertyType = (soil_temp.DomainClass.soil_tempExogenousVarInfo.max_canopy_temp).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(soil_temp.DomainClass.soil_tempExogenousVarInfo.max_canopy_temp);
            _inputs0_0.Add(pd7);
            ...
            pd8.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.temp_amp).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.temp_amp);
            _outputs0_0.Add(pd8);
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(soil_temp.DomainClass.soil_tempState);
            pd9.PropertyName = "therm_amp";
            pd9.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.therm_amp).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.therm_amp);
            _outputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(soil_temp.DomainClass.soil_tempState);
            pd10.PropertyName = "temp_profile";
            pd10.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile);
            ...
            pd11.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.canopy_temp_avg).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.canopy_temp_avg);
            _outputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(soil_temp.DomainClass.soil_tempState);
            pd12.PropertyName = "layer_temp";
            pd12.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp);
            _outputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(soil_temp.DomainClass.soil_tempState);
            pd13.PropertyName = "prev_temp_profile";
            pd13.PropertyType = (soil_temp.DomainClass.soil_tempStateVarInfo.prev_temp_profile).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(soil_temp.DomainClass.soil_tempStateVarInfo.prev_temp_profile);
            _outputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(soil_temp.DomainClass.soil_tempExogenous);
            pd14.PropertyName = "prev_canopy_temp";
            pd14.PropertyType = (soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp);
            _outputs0_0.Add(pd14);
            mo0_0.Outputs=_outputs0_0;
            List<string> lAssStrat0_0 = new List<string>();
            lAssStrat0_0.Add(typeof(soil_temp.Strategies.temp_amp).FullName);
            lAssStrat0_0.Add(typeof(soil_temp.Strategies.therm_amp).FullName);
        ...
        public string TestPostConditions(soil_temp.DomainClass.soil_tempState s,soil_temp.DomainClass.soil_tempState s1,soil_temp.DomainClass.soil_tempRate r,soil_temp.DomainClass.soil_tempAuxiliary a,soil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r10 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.temp_amp);
                if(r10.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.temp_amp.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.therm_amp);
                if(r11.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.therm_amp.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile);
                if(r12.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.temp_profile.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.canopy_temp_avg);
                if(r13.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.canopy_temp_avg.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp);
                if(r14.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.layer_temp.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempStateVarInfo.prev_temp_profile);
                if(r15.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempStateVarInfo.prev_temp_profile.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp);
                if(r16.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp.ValueType)){prc.AddCondition(r16);}

                string ret = "";
                ret += _temp_amp.TestPostConditions(s, s1, r, a, ex, " strategy soil_temp.Strategies.soil_temp");
                ret += _therm_amp.TestPostConditions(s, s1, r, a, ex, " strategy soil_temp.Strategies.soil_temp");
        ...
        public string TestPreConditions(soil_temp.DomainClass.soil_tempState s,soil_temp.DomainClass.soil_tempState s1,soil_temp.DomainClass.soil_tempRate r,soil_temp.DomainClass.soil_tempAuxiliary a,soil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r3 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq);
                if(r3.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff);
                if(r4.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff.ValueType)){prc.AddCondition(r4);}
                ...
                RangeBasedCondition r6 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempExogenousVarInfo.min_canopy_temp);
                if(r6.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempExogenousVarInfo.min_canopy_temp.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(soil_temp.DomainClass.soil_tempExogenousVarInfo.max_canopy_temp);
                if(r7.ApplicableVarInfoValueTypes.Contains( soil_temp.DomainClass.soil_tempExogenousVarInfo.max_canopy_temp.ValueType)){prc.AddCondition(r7);}
                ...
                ret += _therm_amp.TestPreConditions(s, s1, r, a, ex, " strategy soil_temp.Strategies.soil_temp");
