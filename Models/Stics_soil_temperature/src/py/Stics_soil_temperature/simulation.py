...
def simulation(datafile, vardata, params, init):
    ...
    for i in range(0,len(df.index)-1):
        ...
        temp_amp,temp_profile,layer_temp,canopy_temp_avg,prev_canopy_temp,prev_temp_profile= soil_tempComponent.model_soil_temp(max_temp,min_temp,layer_thick,min_air_temp,air_temp_day1,min_canopy_temp,max_canopy_temp)
