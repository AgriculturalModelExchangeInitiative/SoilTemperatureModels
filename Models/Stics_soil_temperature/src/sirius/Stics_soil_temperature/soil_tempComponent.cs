...
namespace SiriusQualitysoil_temp.Strategies
{
    public class soil_tempComponent : IStrategySiriusQualitysoil_temp
    {
        public soil_tempComponent()
        {
            ...
            pd3.DomainClassType = typeof(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary);
            pd3.PropertyName = "temp_wave_freq";
            pd3.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary);
            pd4.PropertyName = "therm_diff";
            pd4.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff);
            _inputs0_0.Add(pd4);
            ...
            pd9.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp);
            _outputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(SiriusQualitysoil_temp.DomainClass.soil_tempState);
            pd10.PropertyName = "temp_profile";
            pd10.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.temp_profile).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.temp_profile);
            ...
            pd12.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.layer_temp).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.layer_temp);
            ...
            pd14.DomainClassType = typeof(SiriusQualitysoil_temp.DomainClass.soil_tempExogenous);
            pd14.PropertyName = "prev_canopy_temp";
            pd14.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp);
            _outputs0_0.Add(pd14);
            mo0_0.Outputs=_outputs0_0;
            List<string> lAssStrat0_0 = new List<string>();
            lAssStrat0_0.Add(typeof(SiriusQualitysoil_temp.Strategies.temp_amp).FullName);
            lAssStrat0_0.Add(typeof(SiriusQualitysoil_temp.Strategies.therm_amp).FullName);
        ...
        {
            get { return SiriusQualitysoil_temp.Strategies.temp_profile.layer_thickVarInfo;} 
        }

        public static VarInfo air_temp_day1VarInfo
        {
            get { return SiriusQualitysoil_temp.Strategies.temp_profile.air_temp_day1VarInfo;} 
        }
        ...
        public string TestPostConditions(SiriusQualitysoil_temp.DomainClass.soil_tempState s,SiriusQualitysoil_temp.DomainClass.soil_tempState s1,SiriusQualitysoil_temp.DomainClass.soil_tempRate r,SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary a,SiriusQualitysoil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp.CurrentValue=s.therm_amp;
                ...
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.temp_profile);
                if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.temp_profile.ValueType)){prc.AddCondition(r12);}
                ...
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.layer_temp);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.layer_temp.ValueType)){prc.AddCondition(r14);}
                ...
                RangeBasedCondition r16 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp);
                if(r16.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempExogenousVarInfo.prev_canopy_temp.ValueType)){prc.AddCondition(r16);}

                string ret = "";
                ret += _temp_amp.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualitysoil_temp.Strategies.soil_temp");
                ret += _therm_amp.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualitysoil_temp.Strategies.soil_temp");
        ...
        public string TestPreConditions(SiriusQualitysoil_temp.DomainClass.soil_tempState s,SiriusQualitysoil_temp.DomainClass.soil_tempState s1,SiriusQualitysoil_temp.DomainClass.soil_tempRate r,SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary a,SiriusQualitysoil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq.CurrentValue=a.temp_wave_freq;
                SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff.CurrentValue=a.therm_diff;
                ...
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff);
                if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff.ValueType)){prc.AddCondition(r4);}
                ...
                ret += _therm_amp.TestPreConditions(s, s1, r, a, ex, " strategy SiriusQualitysoil_temp.Strategies.soil_temp");
