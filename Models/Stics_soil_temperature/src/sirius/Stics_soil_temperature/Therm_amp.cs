...
{
    public class therm_amp : IStrategySiriusQualitysoil_temp
    {
        public therm_amp()
        {
            ...
            pd1.DomainClassType = typeof(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary);
            pd1.PropertyName = "therm_diff";
            pd1.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff);
            _inputs0_0.Add(pd1);
            PropertyDescription pd2 = new PropertyDescription();
            pd2.DomainClassType = typeof(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary);
            pd2.PropertyName = "temp_wave_freq";
            pd2.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq);
            _inputs0_0.Add(pd2);
            ...
            pd3.PropertyType = (SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp);
            _outputs0_0.Add(pd3);
        ...
        public string TestPostConditions(SiriusQualitysoil_temp.DomainClass.soil_tempState s,SiriusQualitysoil_temp.DomainClass.soil_tempState s1,SiriusQualitysoil_temp.DomainClass.soil_tempRate r,SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary a,SiriusQualitysoil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempStateVarInfo.therm_amp.ValueType)){prc.AddCondition(r3);}
        ...
        public string TestPreConditions(SiriusQualitysoil_temp.DomainClass.soil_tempState s,SiriusQualitysoil_temp.DomainClass.soil_tempState s1,SiriusQualitysoil_temp.DomainClass.soil_tempRate r,SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliary a,SiriusQualitysoil_temp.DomainClass.soil_tempExogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff);
                if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.therm_diff.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualitysoil_temp.DomainClass.soil_tempAuxiliaryVarInfo.temp_wave_freq.ValueType)){prc.AddCondition(r2);}
