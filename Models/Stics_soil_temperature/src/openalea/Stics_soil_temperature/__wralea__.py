...
# This file has been generated at Mon Sep 25 12:35:00 2023
...
__all__ = ['temp_amp_model_temp_amp', 'temp_profile_model_temp_profile', 'layers_temp_model_layers_temp', 'canopy_temp_avg_model_canopy_temp_avg', 'update_model_update', '_2730670816648']
...
_2730670816648 = CompositeNodeFactory(name='soil_temp',
                             description=('\n'
 '\n'
 ...
 '    ShortDescription: None\n'),
   ...
   6: ('amei.stics.soiltemperature', 'update')},
                             elt_connections={  140718015357296: (2, 0, '__out__', 0),
   140718015357328: (3, 0, '__out__', 1),
   140718015357360: (4, 0, '__out__', 2),
   140718015357392: (5, 0, '__out__', 3),
   140718015357424: (6, 0, '__out__', 4),
   140718015357456: (6, 1, '__out__', 5),
   140718015357488: ('__in__', 0, 2, 0),
   140718015357520: ('__in__', 1, 2, 1),
   140718015357552: ('__in__', 2, 3, 1),
   140718015357584: ('__in__', 3, 3, 2),
   140718015357616: ('__in__', 4, 3, 3),
   140718015357648: ('__in__', 5, 3, 4),
   140718015357680: ('__in__', 6, 3, 5),
   140718015357712: ('__in__', 6, 4, 1),
   140718015357744: ('__in__', 7, 5, 0),
   140718015357776: ('__in__', 8, 5, 1),
   140718015357808: (2, 0, 3, 0),
   140718015357840: (3, 0, 4, 0),
   140718015357872: (3, 0, 6, 1),
   140718015357904: (5, 0, 6, 0)},
