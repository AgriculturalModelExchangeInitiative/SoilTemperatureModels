...
# This file has been generated at Sat Apr 29 08:27:29 2023

from openalea.core import *


__name__ = 'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc'
...
soiltemperatureswat_model_soiltemperatureswat = Factory(name='SoilTemperatureSWAT',
                ...
                inputs=[{'name': 'VolumetricWaterContent', 'interface': ISequence, 'value': 0.25}, {'name': 'SurfaceSoilTemperature', 'interface': IFloat(min=-60, max=60, step=1.000000), 'value': 25}, {'name': 'BulkDensity', 'interface': ISequence, 'value': 1.3}, {'name': 'LayerThickness', 'interface': ISequence, 'value': 0.05}, {'name': 'LagCoefficient', 'interface': IFloat(min=0, max=1, step=1.000000), 'value': 0.8}, {'name': 'SoilTemperatureByLayers', 'interface': ISequence, 'value': 15}, {'name': 'AirTemperatureAnnualAverage', 'interface': IFloat(min=-40, max=50, step=1.000000), 'value': 15}, {'name': 'SoilProfileDepth', 'interface': IFloat(min=0, max=50, step=1.000000), 'value': 3}],
...
thermaldiffu_model_thermaldiffu = Factory(name='ThermalDiffu',
                ...
                inputs=[{'name': 'ThermalDiffusivity', 'interface': ISequence, 'value': 0.0025}, {'name': 'ThermalConductivity', 'interface': ISequence, 'value': 1}, {'name': 'HeatCapacity', 'interface': ISequence, 'value': 20}],
...
SurfacePartonSoilSWATHourlyPartonC = CompositeNodeFactory(name='SurfacePartonSoilSWATHourlyPartonC',
 ...
 '    ShortDescription: None\n'),
   ...
   {'interface': ISequence, 'name': 'SoilTemperatureByLayersHourly'}],
                             elt_factory={  2: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
         'SurfaceTemperatureParton'),
   3: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
         'SoilTemperatureSWAT'),
   4: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
         'VolumetricHeatCapacityKluitenberg'),
   5: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
         'ThermalConductivitySIMULAT'),
   6: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
         'ThermalDiffu'),
   7: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
         'RangeOfSoilTemperaturesDAYCENT'),
   8: (  'amei.crop2ml.biomasurfacepartonsoilswathourlypartonc.surfacepartonsoilswathourlypartonc',
   ...
   140722495201776: (4, 0, '__out__', 4),
   140722495201808: (5, 0, '__out__', 5),
   140722495201840: (6, 0, '__out__', 6),
   140722495201872: (7, 0, '__out__', 7),
   140722495201904: (7, 1, '__out__', 8),
   140722495201936: (7, 2, '__out__', 9),
   140722495201968: (8, 0, '__out__', 10),
   140722495202000: ('__in__', 0, 2, 0),
   140722495202032: ('__in__', 1, 2, 1),
   140722495202064: ('__in__', 2, 2, 2),
   140722495202096: ('__in__', 3, 2, 3),
   140722495202128: ('__in__', 4, 2, 4),
   140722495202160: ('__in__', 5, 3, 0),
   140722495202192: ('__in__', 6, 3, 2),
   140722495202224: ('__in__', 7, 3, 3),
   140722495202256: ('__in__', 8, 3, 4),
   140722495202288: ('__in__', 9, 3, 6),
   140722495202320: ('__in__', 10, 3, 7),
   140722495202352: ('__in__', 5, 4, 0),
   140722495202384: ('__in__', 11, 4, 1),
   140722495202416: ('__in__', 6, 4, 2),
   140722495202448: ('__in__', 12, 4, 3),
   140722495202480: ('__in__', 13, 4, 5),
   140722495202512: ('__in__', 14, 4, 6),
   140722495202544: ('__in__', 5, 5, 0),
   140722495202576: ('__in__', 13, 5, 2),
   140722495202608: ('__in__', 6, 5, 1),
   140722495202640: ('__in__', 7, 7, 0),
   140722495202672: ('__in__', 15, 8, 1),
   140722495202704: ('__in__', 16, 8, 2),
   140722495202736: ('__in__', 1, 8, 3),
   140722495202768: (2, 0, 3, 1),
   140722495202800: (2, 2, 7, 4),
   140722495202832: (2, 1, 7, 1),
   140722495202864: (3, 0, 7, 3),
   140722495202896: (4, 0, 6, 2),
   140722495202928: (5, 0, 6, 1),
   140722495202960: (6, 0, 7, 2),
   140722495202992: (7, 1, 8, 4),
   140722495203024: (7, 2, 8, 5)},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'position': [-65, 100.0], 'userColor': None, 'useUserColor': True},
   3: {'position': [-38.684210526315795, 100.0], 'userColor': None, 'useUserColor': True},
   4: {'position': [-12.368421052631586, 100.0], 'userColor': None, 'useUserColor': True},
   5: {'position': [13.947368421052623, 100.0], 'userColor': None, 'useUserColor': True},
   6: {'position': [0.947368421052623, 200.0], 'userColor': None, 'useUserColor': True},
   7: {'position': [40.263157894736835, 100.0], 'userColor': None, 'useUserColor': True},
   8: {'position': [66.57894736842104, 100.0], 'userColor': None, 'useUserColor': True},
