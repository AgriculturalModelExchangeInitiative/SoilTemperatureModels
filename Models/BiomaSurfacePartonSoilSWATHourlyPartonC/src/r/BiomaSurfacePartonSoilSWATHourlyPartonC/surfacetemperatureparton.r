...
model_surfacetemperatureparton <- function (GlobalSolarRadiation,
         DayLength,
         AboveGroundBiomass,
    ...
    return (list ("SurfaceSoilTemperature" = SurfaceSoilTemperature,"SurfaceTemperatureMinimum" = SurfaceTemperatureMinimum,"SurfaceTemperatureMaximum" = SurfaceTemperatureMaximum))
}