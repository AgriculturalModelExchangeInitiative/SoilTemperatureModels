...
namespace UNIMI.SoilT.Strategies.Soil
{
    ...
    /// </summary>
	public class ThermalDiffu : IStrategySoilT
	{
	...
	#region Constructor
			...
			public ThermalDiffu()
			{
                ...
                pd1.PropertyType = ((UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalConductivity)).ValueType.TypeForCurrentValue;
                pd1.PropertyVarInfo = (UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalConductivity);
				_inputs0_0.Add(pd1);
                PropertyDescription pd2 = new PropertyDescription();
                pd2.DomainClassType = typeof(UNIMI.SoilT.Interfaces.States);
                pd2.PropertyName = "HeatCapacity";
                pd2.PropertyType = ((UNIMI.SoilT.Interfaces.StatesVarInfo.HeatCapacity)).ValueType.TypeForCurrentValue;
                pd2.PropertyVarInfo = (UNIMI.SoilT.Interfaces.StatesVarInfo.HeatCapacity);
                _inputs0_0.Add(pd2);
                ...
                pd4.PropertyType = ((UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity)).ValueType.TypeForCurrentValue;
                pd4.PropertyVarInfo = (UNIMI.SoilT.Interfaces.StatesVarInfo.ThermalDiffusivity);
                _inputs0_0.Add(pd4);
