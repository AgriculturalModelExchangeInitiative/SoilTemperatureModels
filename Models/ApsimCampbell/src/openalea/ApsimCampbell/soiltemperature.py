...
def getIniVariables(instrumHeight:float,
         defaultInstrumentHeight:float,
         instrumentHeight:float):
...
def getProfileVariables(maxSoilTemp:'Array[float]',
         minSoilTemp:'Array[float]',
         topsoilNode:int,
         thermalConductance:'Array[float]',
         physical_BD:'Array[float]',
...
def readParam(soilTemp:'Array[float]',
         soilRoughnessHeight:float,
         newTemperature:'Array[float]',
         bareSoilRoughness:float,
         thermCondPar2:'Array[float]',
...
def getOtherVariables(soilWater:'Array[float]',
         instrumentHeight:float,
         microClimate_CanopyHeight:float,
         waterBalance_SW:'Array[float]',
         numNodes:int,
...
def doProcess(maxSoilTemp:'Array[float]',
         minSoilTemp:'Array[float]',
         weather_MaxT:float,
         numIterationsForBoundaryLayerConductance:int,
         maxTempYesterday:float,
...
def calcSurfaceTemperature(waterBalance_Salb:float,
         weather_MeanT:float,
         weather_Radn:float,
         weather_MaxT:float):
    surfaceT:float
