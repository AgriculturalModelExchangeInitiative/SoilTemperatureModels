...
{
    public class SoilTemperature : IStrategySiriusQualitySoiltemp
    {
        public SoilTemperature()
        {
            ...
            pd1.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT);
            _inputs0_0.Add(pd1);
            ...
            pd3.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd4.PropertyName = "weather_Tav";
            pd4.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd5.PropertyName = "weather_Amp";
            pd5.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp);
            _inputs0_0.Add(pd5);
            ...
            pd6.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd7.PropertyName = "weather_Wind";
            pd7.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd8.PropertyName = "weather_Latitude";
            pd8.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude);
            _inputs0_0.Add(pd8);
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd9.PropertyName = "weather_Radn";
            pd9.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Radn).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Radn);
            _inputs0_0.Add(pd9);
            ...
            pd10.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear);
            _inputs0_0.Add(pd10);
            ...
            pd11.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.microClimate_CanopyHeight).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.microClimate_CanopyHeight);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd12.PropertyName = "physical_Rocks";
            pd12.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks);
            _inputs0_0.Add(pd12);
            ...
            pd13.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd14.PropertyName = "physical_ParticleSizeSilt";
            pd14.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt);
            _inputs0_0.Add(pd14);
            ...
            pd15.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon);
            _inputs0_0.Add(pd16);
            ...
            pd17.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW);
            _inputs0_0.Add(pd17);
            ...
            pd18.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos);
            _inputs0_0.Add(pd18);
            ...
            pd19.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo);
            _inputs0_0.Add(pd19);
            ...
            pd20.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es).ValueType.TypeForCurrentValue;
            pd20.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es);
            _inputs0_0.Add(pd20);
            PropertyDescription pd21 = new PropertyDescription();
            pd21.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd21.PropertyName = "waterBalance_Salb";
            pd21.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb).ValueType.TypeForCurrentValue;
            pd21.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb);
            _inputs0_0.Add(pd21);
            PropertyDescription pd22 = new PropertyDescription();
            pd22.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempExogenous);
            pd22.PropertyName = "timestep";
            pd22.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.timestep).ValueType.TypeForCurrentValue;
            pd22.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.timestep);
            _inputs0_0.Add(pd22);
            ...
            pd23.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff).ValueType.TypeForCurrentValue;
            pd23.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff);
            _inputs0_0.Add(pd23);
            ...
            pd24.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep).ValueType.TypeForCurrentValue;
            pd24.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep);
            _inputs0_0.Add(pd24);
            PropertyDescription pd25 = new PropertyDescription();
            pd25.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd25.PropertyName = "timeOfDaySecs";
            pd25.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs).ValueType.TypeForCurrentValue;
            pd25.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs);
            _inputs0_0.Add(pd25);
            ...
            pd26.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numNodes).ValueType.TypeForCurrentValue;
            pd26.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numNodes);
            _inputs0_0.Add(pd26);
            PropertyDescription pd27 = new PropertyDescription();
            pd27.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd27.PropertyName = "numLayers";
            pd27.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numLayers).ValueType.TypeForCurrentValue;
            pd27.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numLayers);
            _inputs0_0.Add(pd27);
            ...
            pd28.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil).ValueType.TypeForCurrentValue;
            pd28.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil);
            _inputs0_0.Add(pd28);
            ...
            pd29.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilTemp).ValueType.TypeForCurrentValue;
            pd29.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilTemp);
            _inputs0_0.Add(pd29);
            PropertyDescription pd30 = new PropertyDescription();
            pd30.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd30.PropertyName = "morningSoilTemp";
            pd30.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp).ValueType.TypeForCurrentValue;
            pd30.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp);
            _inputs0_0.Add(pd30);
            PropertyDescription pd31 = new PropertyDescription();
            pd31.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd31.PropertyName = "heatStorage";
            pd31.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.heatStorage).ValueType.TypeForCurrentValue;
            pd31.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.heatStorage);
            _inputs0_0.Add(pd31);
            PropertyDescription pd32 = new PropertyDescription();
            pd32.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd32.PropertyName = "thermalConductance";
            pd32.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance).ValueType.TypeForCurrentValue;
            pd32.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance);
            _inputs0_0.Add(pd32);
            ...
            pd33.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity).ValueType.TypeForCurrentValue;
            pd33.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity);
            _inputs0_0.Add(pd33);
            ...
            pd34.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance).ValueType.TypeForCurrentValue;
            pd34.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance);
            _inputs0_0.Add(pd34);
            ...
            pd35.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.newTemperature).ValueType.TypeForCurrentValue;
            pd35.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.newTemperature);
            _inputs0_0.Add(pd35);
            ...
            pd36.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.airTemperature).ValueType.TypeForCurrentValue;
            pd36.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.airTemperature);
            _inputs0_0.Add(pd36);
            ...
            pd37.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday).ValueType.TypeForCurrentValue;
            pd37.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday);
            _inputs0_0.Add(pd37);
            PropertyDescription pd38 = new PropertyDescription();
            pd38.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd38.PropertyName = "minTempYesterday";
            pd38.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday).ValueType.TypeForCurrentValue;
            pd38.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday);
            _inputs0_0.Add(pd38);
            ...
            pd39.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilWater).ValueType.TypeForCurrentValue;
            pd39.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilWater);
            _inputs0_0.Add(pd39);
            PropertyDescription pd40 = new PropertyDescription();
            pd40.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd40.PropertyName = "minSoilTemp";
            pd40.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp).ValueType.TypeForCurrentValue;
            pd40.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp);
            _inputs0_0.Add(pd40);
            ...
            pd41.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp).ValueType.TypeForCurrentValue;
            pd41.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp);
            _inputs0_0.Add(pd41);
            PropertyDescription pd42 = new PropertyDescription();
            pd42.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd42.PropertyName = "aveSoilTemp";
            pd42.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp).ValueType.TypeForCurrentValue;
            pd42.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp);
            _inputs0_0.Add(pd42);
            PropertyDescription pd43 = new PropertyDescription();
            pd43.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd43.PropertyName = "aveSoilWater";
            pd43.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater).ValueType.TypeForCurrentValue;
            pd43.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater);
            _inputs0_0.Add(pd43);
            PropertyDescription pd44 = new PropertyDescription();
            pd44.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd44.PropertyName = "thickness";
            pd44.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thickness).ValueType.TypeForCurrentValue;
            pd44.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thickness);
            _inputs0_0.Add(pd44);
            PropertyDescription pd45 = new PropertyDescription();
            pd45.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd45.PropertyName = "bulkDensity";
            pd45.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity).ValueType.TypeForCurrentValue;
            pd45.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity);
            _inputs0_0.Add(pd45);
            PropertyDescription pd46 = new PropertyDescription();
            pd46.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd46.PropertyName = "rocks";
            pd46.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.rocks).ValueType.TypeForCurrentValue;
            pd46.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.rocks);
            _inputs0_0.Add(pd46);
            ...
            pd47.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.carbon).ValueType.TypeForCurrentValue;
            pd47.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.carbon);
            _inputs0_0.Add(pd47);
            PropertyDescription pd48 = new PropertyDescription();
            pd48.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd48.PropertyName = "sand";
            pd48.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.sand).ValueType.TypeForCurrentValue;
            pd48.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.sand);
            _inputs0_0.Add(pd48);
            PropertyDescription pd49 = new PropertyDescription();
            pd49.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd49.PropertyName = "silt";
            pd49.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.silt).ValueType.TypeForCurrentValue;
            pd49.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.silt);
            _inputs0_0.Add(pd49);
            ...
            pd50.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.clay).ValueType.TypeForCurrentValue;
            pd50.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.clay);
            _inputs0_0.Add(pd50);
            ...
            pd51.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight).ValueType.TypeForCurrentValue;
            pd51.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight);
            _inputs0_0.Add(pd51);
            PropertyDescription pd52 = new PropertyDescription();
            pd52.DomainClassType = typeof(SiriusQualitySoiltemp.DomainClass.SoiltempState);
            pd52.PropertyName = "netRadiation";
            pd52.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.netRadiation).ValueType.TypeForCurrentValue;
            pd52.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.netRadiation);
            _inputs0_0.Add(pd52);
            ...
            pd53.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight).ValueType.TypeForCurrentValue;
            pd53.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight);
            _inputs0_0.Add(pd53);
            ...
            pd54.PropertyType = (SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight).ValueType.TypeForCurrentValue;
            pd54.PropertyVarInfo =(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight);
            _inputs0_0.Add(pd54);
        ...
        public string TestPreConditions(SiriusQualitySoiltemp.DomainClass.SoiltempState s,SiriusQualitySoiltemp.DomainClass.SoiltempState s1,SiriusQualitySoiltemp.DomainClass.SoiltempRate r,SiriusQualitySoiltemp.DomainClass.SoiltempAuxiliary a,SiriusQualitySoiltemp.DomainClass.SoiltempExogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT);
                if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT.ValueType)){prc.AddCondition(r1);}
                ...
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav);
                if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp);
                if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure);
                if(r6.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind);
                if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude);
                if(r8.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Radn);
                if(r9.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Radn.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear);
                if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.microClimate_CanopyHeight);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.microClimate_CanopyHeight.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks);
                if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand);
                if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay);
                if(r15.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon);
                if(r16.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW);
                if(r17.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW.ValueType)){prc.AddCondition(r17);}
                RangeBasedCondition r18 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos);
                if(r18.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos.ValueType)){prc.AddCondition(r18);}
                RangeBasedCondition r19 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo);
                if(r19.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo.ValueType)){prc.AddCondition(r19);}
                RangeBasedCondition r20 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es);
                if(r20.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es.ValueType)){prc.AddCondition(r20);}
                RangeBasedCondition r21 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb);
                if(r21.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb.ValueType)){prc.AddCondition(r21);}
                RangeBasedCondition r22 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.timestep);
                if(r22.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempExogenousVarInfo.timestep.ValueType)){prc.AddCondition(r22);}
                RangeBasedCondition r23 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff);
                if(r23.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff.ValueType)){prc.AddCondition(r23);}
                RangeBasedCondition r24 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep);
                if(r24.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep.ValueType)){prc.AddCondition(r24);}
                RangeBasedCondition r25 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs);
                if(r25.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs.ValueType)){prc.AddCondition(r25);}
                RangeBasedCondition r26 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numNodes);
                if(r26.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numNodes.ValueType)){prc.AddCondition(r26);}
                RangeBasedCondition r27 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numLayers);
                if(r27.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.numLayers.ValueType)){prc.AddCondition(r27);}
                RangeBasedCondition r28 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil);
                if(r28.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilTemp);
                if(r29.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilTemp.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp);
                if(r30.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp.ValueType)){prc.AddCondition(r30);}
                RangeBasedCondition r31 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.heatStorage);
                if(r31.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.heatStorage.ValueType)){prc.AddCondition(r31);}
                RangeBasedCondition r32 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance);
                if(r32.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance.ValueType)){prc.AddCondition(r32);}
                RangeBasedCondition r33 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity);
                if(r33.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity.ValueType)){prc.AddCondition(r33);}
                RangeBasedCondition r34 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance);
                if(r34.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance.ValueType)){prc.AddCondition(r34);}
                RangeBasedCondition r35 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.newTemperature);
                if(r35.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.newTemperature.ValueType)){prc.AddCondition(r35);}
                RangeBasedCondition r36 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.airTemperature);
                if(r36.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.airTemperature.ValueType)){prc.AddCondition(r36);}
                RangeBasedCondition r37 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday);
                if(r37.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday.ValueType)){prc.AddCondition(r37);}
                RangeBasedCondition r38 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday);
                if(r38.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday.ValueType)){prc.AddCondition(r38);}
                RangeBasedCondition r39 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilWater);
                if(r39.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.soilWater.ValueType)){prc.AddCondition(r39);}
                RangeBasedCondition r40 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp);
                if(r40.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp.ValueType)){prc.AddCondition(r40);}
                RangeBasedCondition r41 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp);
                if(r41.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp.ValueType)){prc.AddCondition(r41);}
                RangeBasedCondition r42 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp);
                if(r42.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp.ValueType)){prc.AddCondition(r42);}
                RangeBasedCondition r43 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater);
                if(r43.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater.ValueType)){prc.AddCondition(r43);}
                RangeBasedCondition r44 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thickness);
                if(r44.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.thickness.ValueType)){prc.AddCondition(r44);}
                RangeBasedCondition r45 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity);
                if(r45.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity.ValueType)){prc.AddCondition(r45);}
                RangeBasedCondition r46 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.rocks);
                if(r46.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.rocks.ValueType)){prc.AddCondition(r46);}
                RangeBasedCondition r47 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.carbon);
                if(r47.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.carbon.ValueType)){prc.AddCondition(r47);}
                RangeBasedCondition r48 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.sand);
                if(r48.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.sand.ValueType)){prc.AddCondition(r48);}
                RangeBasedCondition r49 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.silt);
                if(r49.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.silt.ValueType)){prc.AddCondition(r49);}
                RangeBasedCondition r50 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.clay);
                if(r50.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.clay.ValueType)){prc.AddCondition(r50);}
                RangeBasedCondition r51 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight);
                if(r51.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight.ValueType)){prc.AddCondition(r51);}
                RangeBasedCondition r52 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.netRadiation);
                if(r52.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.netRadiation.ValueType)){prc.AddCondition(r52);}
                RangeBasedCondition r53 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight);
                if(r53.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight.ValueType)){prc.AddCondition(r53);}
                RangeBasedCondition r54 = new RangeBasedCondition(SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight);
                if(r54.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight.ValueType)){prc.AddCondition(r54);}
