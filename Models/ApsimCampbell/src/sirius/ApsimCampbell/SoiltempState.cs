...
namespace SiriusQualitySoiltemp.DomainClass
{
                ...
                public double internalTimeStep
    {
        ...
        set { this._internalTimeStep= value; } 
                ...
                {
                     _thermalConductance = new double[];
                     _newTemperature = new double[];
                     _instrumentHeight = default(double);
                     _aveSoilWater = new double[];
