...
namespace Soiltemp.DomainClass
                                {
                                    public class SoiltempExogenousVarInfo : IVarInfoClass
                                    {
                                        ...
                                        static VarInfo _weather_Latitude = new VarInfo();
                                        static VarInfo _weather_Amp = new VarInfo();
                                        static VarInfo _timestep = new VarInfo();
                                        ...
                                        public static  VarInfo weather_Latitude
                                        {
                                            get { return _weather_Latitude;}
                                        }
                                        ...
                                        public static  VarInfo timestep
                                        {
                                        ...
                                        static void DescribeVariables()
                                        {
                                            ...
                                            _weather_Latitude.Name = "weather_Latitude";
                                            _weather_Latitude.Description = "Latitude";
                                            _weather_Latitude.MaxValue = -1D;
                                            _weather_Latitude.MinValue = -1D;
                                            _weather_Latitude.DefaultValue = -1D;
                                            _weather_Latitude.Units = "deg";
                                            _weather_Latitude.ValueType = VarInfoValueTypes.GetInstanceForName("Double");
                                            ...
                                            _timestep.Name = "timestep";
                                            _timestep.Description = "Internal time-step (minutes)";
                                            _timestep.MaxValue = -1D;
                                            _timestep.MinValue = -1D;
                                            _timestep.DefaultValue = 24.0 * 60.0 * 60.0;
                                            _timestep.Units = "minutes";
                                            _timestep.ValueType = VarInfoValueTypes.GetInstanceForName("Double");
