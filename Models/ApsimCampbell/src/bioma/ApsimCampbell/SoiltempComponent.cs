...
namespace Soiltemp.Strategies
{
    public class SoiltempComponent : IStrategySoiltemp
    {
        public SoiltempComponent()
        {
            ...
            pd1.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance);
            _inputs0_0.Add(pd1);
            ...
            pd3.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.newTemperature).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.newTemperature);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd4.PropertyName = "instrumentHeight";
            pd4.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd5.PropertyName = "aveSoilWater";
            pd5.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd6.PropertyName = "thermalConductivity";
            pd6.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd7.PropertyName = "silt";
            pd7.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.silt).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.silt);
            _inputs0_0.Add(pd7);
            ...
            pd9.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity);
            _inputs0_0.Add(pd9);
            ...
            pd11.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd12.PropertyName = "physical_ParticleSizeClay";
            pd12.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay);
            _inputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd13.PropertyName = "netRadiation";
            pd13.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.netRadiation).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.netRadiation);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd14.PropertyName = "rocks";
            pd14.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.rocks).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.rocks);
            _inputs0_0.Add(pd14);
            PropertyDescription pd15 = new PropertyDescription();
            pd15.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd15.PropertyName = "numLayers";
            pd15.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.numLayers).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.numLayers);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp);
            _inputs0_0.Add(pd16);
            PropertyDescription pd17 = new PropertyDescription();
            pd17.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempState);
            pd17.PropertyName = "instrumHeight";
            pd17.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight);
            _inputs0_0.Add(pd17);
            ...
            pd18.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.soilTemp).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.soilTemp);
            _inputs0_0.Add(pd18);
            ...
            pd19.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind);
            _inputs0_0.Add(pd19);
            ...
            pd20.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand).ValueType.TypeForCurrentValue;
            pd20.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand);
            _inputs0_0.Add(pd20);
            ...
            pd21.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff).ValueType.TypeForCurrentValue;
            pd21.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff);
            _inputs0_0.Add(pd21);
            ...
            pd22.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight).ValueType.TypeForCurrentValue;
            pd22.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight);
            _inputs0_0.Add(pd22);
            ...
            pd23.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance).ValueType.TypeForCurrentValue;
            pd23.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance);
            _inputs0_0.Add(pd23);
            ...
            pd24.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.soilWater).ValueType.TypeForCurrentValue;
            pd24.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.soilWater);
            _inputs0_0.Add(pd24);
            PropertyDescription pd25 = new PropertyDescription();
            pd25.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd25.PropertyName = "waterBalance_Eos";
            pd25.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos).ValueType.TypeForCurrentValue;
            pd25.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos);
            _inputs0_0.Add(pd25);
            ...
            pd26.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday).ValueType.TypeForCurrentValue;
            pd26.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday);
            _inputs0_0.Add(pd26);
            ...
            pd27.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT).ValueType.TypeForCurrentValue;
            pd27.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT);
            _inputs0_0.Add(pd27);
            ...
            pd28.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.clay).ValueType.TypeForCurrentValue;
            pd28.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.clay);
            _inputs0_0.Add(pd28);
            ...
            pd29.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.thickness).ValueType.TypeForCurrentValue;
            pd29.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.thickness);
            _inputs0_0.Add(pd29);
            ...
            pd30.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude).ValueType.TypeForCurrentValue;
            pd30.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude);
            _inputs0_0.Add(pd30);
            PropertyDescription pd31 = new PropertyDescription();
            pd31.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd31.PropertyName = "weather_Amp";
            pd31.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp).ValueType.TypeForCurrentValue;
            pd31.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp);
            _inputs0_0.Add(pd31);
            PropertyDescription pd32 = new PropertyDescription();
            pd32.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd32.PropertyName = "timestep";
            pd32.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.timestep).ValueType.TypeForCurrentValue;
            pd32.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.timestep);
            _inputs0_0.Add(pd32);
            ...
            pd33.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp).ValueType.TypeForCurrentValue;
            pd33.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp);
            _inputs0_0.Add(pd33);
            ...
            pd34.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs).ValueType.TypeForCurrentValue;
            pd34.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs);
            _inputs0_0.Add(pd34);
            ...
            pd35.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.carbon).ValueType.TypeForCurrentValue;
            pd35.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.carbon);
            _inputs0_0.Add(pd35);
            ...
            pd36.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.heatStorage).ValueType.TypeForCurrentValue;
            pd36.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.heatStorage);
            _inputs0_0.Add(pd36);
            ...
            pd37.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp).ValueType.TypeForCurrentValue;
            pd37.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp);
            _inputs0_0.Add(pd37);
            ...
            pd38.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb).ValueType.TypeForCurrentValue;
            pd38.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb);
            _inputs0_0.Add(pd38);
            ...
            pd39.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday).ValueType.TypeForCurrentValue;
            pd39.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday);
            _inputs0_0.Add(pd39);
            PropertyDescription pd40 = new PropertyDescription();
            pd40.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd40.PropertyName = "physical_ParticleSizeSilt";
            pd40.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt).ValueType.TypeForCurrentValue;
            pd40.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt);
            _inputs0_0.Add(pd40);
            ...
            pd41.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.numNodes).ValueType.TypeForCurrentValue;
            pd41.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.numNodes);
            _inputs0_0.Add(pd41);
            ...
            pd42.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear).ValueType.TypeForCurrentValue;
            pd42.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear);
            _inputs0_0.Add(pd42);
            PropertyDescription pd43 = new PropertyDescription();
            pd43.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd43.PropertyName = "waterBalance_Eo";
            pd43.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo).ValueType.TypeForCurrentValue;
            pd43.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo);
            _inputs0_0.Add(pd43);
            PropertyDescription pd44 = new PropertyDescription();
            pd44.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd44.PropertyName = "waterBalance_SW";
            pd44.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW).ValueType.TypeForCurrentValue;
            pd44.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW);
            _inputs0_0.Add(pd44);
            PropertyDescription pd45 = new PropertyDescription();
            pd45.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd45.PropertyName = "waterBalance_Es";
            pd45.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es).ValueType.TypeForCurrentValue;
            pd45.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es);
            _inputs0_0.Add(pd45);
            ...
            pd46.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav).ValueType.TypeForCurrentValue;
            pd46.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav);
            _inputs0_0.Add(pd46);
            ...
            pd47.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil).ValueType.TypeForCurrentValue;
            pd47.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil);
            _inputs0_0.Add(pd47);
            PropertyDescription pd48 = new PropertyDescription();
            pd48.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd48.PropertyName = "physical_Rocks";
            pd48.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks).ValueType.TypeForCurrentValue;
            pd48.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks);
            _inputs0_0.Add(pd48);
            ...
            pd49.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure).ValueType.TypeForCurrentValue;
            pd49.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure);
            _inputs0_0.Add(pd49);
            ...
            pd50.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.sand).ValueType.TypeForCurrentValue;
            pd50.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.sand);
            _inputs0_0.Add(pd50);
            ...
            pd51.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp).ValueType.TypeForCurrentValue;
            pd51.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp);
            _inputs0_0.Add(pd51);
            PropertyDescription pd52 = new PropertyDescription();
            pd52.DomainClassType = typeof(Soiltemp.DomainClass.SoiltempExogenous);
            pd52.PropertyName = "organic_Carbon";
            pd52.PropertyType = (Soiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon).ValueType.TypeForCurrentValue;
            pd52.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon);
            _inputs0_0.Add(pd52);
            ...
            pd53.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.airTemperature).ValueType.TypeForCurrentValue;
            pd53.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.airTemperature);
            _inputs0_0.Add(pd53);
            ...
            pd54.PropertyType = (Soiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep).ValueType.TypeForCurrentValue;
            pd54.PropertyVarInfo =(Soiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep);
            _inputs0_0.Add(pd54);
        ...
        {
            get { return Soiltemp.Strategies.{'modu': 'SoilTemperature', 'var': 'Thickness'}.ThicknessVarInfo;} 
        }
        ...
        {
            get { return Soiltemp.Strategies.{'modu': 'SoilTemperature', 'var': 'InitialValues'}.InitialValuesVarInfo;} 
        }
        ...
        public string TestPreConditions(Soiltemp.DomainClass.SoiltempState s,Soiltemp.DomainClass.SoiltempState s1,Soiltemp.DomainClass.SoiltempRate r,Soiltemp.DomainClass.SoiltempAuxiliary a,Soiltemp.DomainClass.SoiltempExogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance);
                if(r1.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductance.ValueType)){prc.AddCondition(r1);}
                ...
                RangeBasedCondition r3 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.newTemperature);
                if(r3.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.newTemperature.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight);
                if(r4.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.instrumentHeight.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater);
                if(r5.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilWater.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity);
                if(r6.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.thermalConductivity.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.silt);
                if(r7.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.silt.ValueType)){prc.AddCondition(r7);}
                ...
                RangeBasedCondition r9 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity);
                if(r9.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.bulkDensity.ValueType)){prc.AddCondition(r9);}
                ...
                RangeBasedCondition r11 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT);
                if(r11.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MinT.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay);
                if(r12.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeClay.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.netRadiation);
                if(r13.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.netRadiation.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.rocks);
                if(r14.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.rocks.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.numLayers);
                if(r15.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.numLayers.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp);
                if(r16.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.minSoilTemp.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight);
                if(r17.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.instrumHeight.ValueType)){prc.AddCondition(r17);}
                RangeBasedCondition r18 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.soilTemp);
                if(r18.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.soilTemp.ValueType)){prc.AddCondition(r18);}
                RangeBasedCondition r19 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind);
                if(r19.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Wind.ValueType)){prc.AddCondition(r19);}
                RangeBasedCondition r20 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand);
                if(r20.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSand.ValueType)){prc.AddCondition(r20);}
                RangeBasedCondition r21 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff);
                if(r21.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.doInitialisationStuff.ValueType)){prc.AddCondition(r21);}
                RangeBasedCondition r22 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight);
                if(r22.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.canopyHeight.ValueType)){prc.AddCondition(r22);}
                RangeBasedCondition r23 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance);
                if(r23.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.boundaryLayerConductance.ValueType)){prc.AddCondition(r23);}
                RangeBasedCondition r24 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.soilWater);
                if(r24.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.soilWater.ValueType)){prc.AddCondition(r24);}
                RangeBasedCondition r25 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos);
                if(r25.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eos.ValueType)){prc.AddCondition(r25);}
                RangeBasedCondition r26 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday);
                if(r26.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.maxTempYesterday.ValueType)){prc.AddCondition(r26);}
                RangeBasedCondition r27 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT);
                if(r27.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_MeanT.ValueType)){prc.AddCondition(r27);}
                RangeBasedCondition r28 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.clay);
                if(r28.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.clay.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.thickness);
                if(r29.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.thickness.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude);
                if(r30.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Latitude.ValueType)){prc.AddCondition(r30);}
                RangeBasedCondition r31 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp);
                if(r31.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Amp.ValueType)){prc.AddCondition(r31);}
                RangeBasedCondition r32 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.timestep);
                if(r32.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.timestep.ValueType)){prc.AddCondition(r32);}
                RangeBasedCondition r33 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp);
                if(r33.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.maxSoilTemp.ValueType)){prc.AddCondition(r33);}
                RangeBasedCondition r34 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs);
                if(r34.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.timeOfDaySecs.ValueType)){prc.AddCondition(r34);}
                RangeBasedCondition r35 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.carbon);
                if(r35.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.carbon.ValueType)){prc.AddCondition(r35);}
                RangeBasedCondition r36 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.heatStorage);
                if(r36.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.heatStorage.ValueType)){prc.AddCondition(r36);}
                RangeBasedCondition r37 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp);
                if(r37.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.aveSoilTemp.ValueType)){prc.AddCondition(r37);}
                RangeBasedCondition r38 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb);
                if(r38.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Salb.ValueType)){prc.AddCondition(r38);}
                RangeBasedCondition r39 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday);
                if(r39.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.minTempYesterday.ValueType)){prc.AddCondition(r39);}
                RangeBasedCondition r40 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt);
                if(r40.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_ParticleSizeSilt.ValueType)){prc.AddCondition(r40);}
                RangeBasedCondition r41 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.numNodes);
                if(r41.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.numNodes.ValueType)){prc.AddCondition(r41);}
                RangeBasedCondition r42 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear);
                if(r42.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.clock_Today_DayOfYear.ValueType)){prc.AddCondition(r42);}
                RangeBasedCondition r43 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo);
                if(r43.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Eo.ValueType)){prc.AddCondition(r43);}
                RangeBasedCondition r44 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW);
                if(r44.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_SW.ValueType)){prc.AddCondition(r44);}
                RangeBasedCondition r45 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es);
                if(r45.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.waterBalance_Es.ValueType)){prc.AddCondition(r45);}
                RangeBasedCondition r46 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav);
                if(r46.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_Tav.ValueType)){prc.AddCondition(r46);}
                RangeBasedCondition r47 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil);
                if(r47.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.volSpecHeatSoil.ValueType)){prc.AddCondition(r47);}
                RangeBasedCondition r48 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks);
                if(r48.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.physical_Rocks.ValueType)){prc.AddCondition(r48);}
                RangeBasedCondition r49 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure);
                if(r49.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.weather_AirPressure.ValueType)){prc.AddCondition(r49);}
                RangeBasedCondition r50 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.sand);
                if(r50.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.sand.ValueType)){prc.AddCondition(r50);}
                RangeBasedCondition r51 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp);
                if(r51.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.morningSoilTemp.ValueType)){prc.AddCondition(r51);}
                RangeBasedCondition r52 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon);
                if(r52.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempExogenousVarInfo.organic_Carbon.ValueType)){prc.AddCondition(r52);}
                RangeBasedCondition r53 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.airTemperature);
                if(r53.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.airTemperature.ValueType)){prc.AddCondition(r53);}
                RangeBasedCondition r54 = new RangeBasedCondition(Soiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep);
                if(r54.ApplicableVarInfoValueTypes.Contains( Soiltemp.DomainClass.SoiltempStateVarInfo.internalTimeStep.ValueType)){prc.AddCondition(r54);}
